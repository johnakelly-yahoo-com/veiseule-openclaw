...
- **Live stream preview:** ရွေးချယ်နိုင်သော `channels.telegram.streamMode` သည် ယာယီမက်ဆေ့ချ်တစ်ခု ပို့ပြီး `editMessageText` ဖြင့် ထိုမက်ဆေ့ချ်ကို အပ်ဒိတ်လုပ်ပေးသည်။ This is separate from channel block streaming.
