...
အခြေအနေ: စမ်းသပ်ဆဲ။ ဤပေါင်းစည်းမှုသည် `zca-cli` ကို အသုံးပြု၍ **ကိုယ်ပိုင် Zalo အကောင့်** ကို အလိုအလျောက် လုပ်ဆောင်စေပါသည်။

> **သတိပေးချက်:** ဤပေါင်းစည်းမှုသည် တရားဝင်မဟုတ်ပါ။ အကောင့် ရပ်ဆိုင်းခြင်း/ပိတ်ပင်ခြင်း ဖြစ်နိုင်ပါသည်။ မိမိတာဝန်ယူ၍ အသုံးပြုပါ။
...
Channel id ကို `zalouser` ဟု သတ်မှတ်ထားသည်မှာ ဤအရာသည် **ကိုယ်ပိုင် Zalo အသုံးပြုသူ အကောင့်** (တရားဝင်မဟုတ်) ကို အလိုအလျောက် လုပ်ဆောင်စေသည်ကို ရှင်းလင်းစွာ ဖော်ပြရန် ဖြစ်သည်။ အနာဂတ်တွင် တရားဝင် Zalo API ပေါင်းစည်းမှု ဖြစ်နိုင်ခြေအတွက် `zalo` ကို သီးသန့် ထားရှိထားပါသည်။
...
`channels.zalouser.dmPolicy` သည် အောက်ပါတို့ကို ပံ့ပိုးပါသည် - `pairing | allowlist | open | disabled` (မူလတန်ဖိုး - `pairing`)။
...
- မူလတန်ဖိုး - `channels.zalouser.groupPolicy = "open"` (အုပ်စုများ ခွင့်ပြုထားသည်)။ မသတ်မှတ်ရသေးပါက မူလတန်ဖိုးကို ပြောင်းလဲရန် `channels.defaults.groupPolicy` ကို အသုံးပြုပါ။
