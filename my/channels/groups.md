...
OpenClaw သည် သင့်ကိုယ်ပိုင် messaging အကောင့်များပေါ်တွင် တိုက်ရိုက် အလုပ်လုပ်ပါသည်။ သီးခြား WhatsApp bot user မရှိပါ။
...
ဘာကြောင့်လဲဆိုတော့ single-agent mode တွင် DM များသည် ပုံမှန်အားဖြင့် **main** session key (`agent:main:main`) ထဲသို့ ရောက်ရှိတတ်ပြီး၊ group များသည် အမြဲတမ်း **non-main** session key များ (`agent:main:<channel>:group:<id>`) ကို အသုံးပြုပါသည်။ `mode: "non-main"` ဖြင့် sandboxing ကို ဖွင့်ထားပါက၊ ထို group session များသည် Docker ထဲတွင် လည်ပတ်မည်ဖြစ်ပြီး သင့်၏ main DM session သည် host ပေါ်တွင် ဆက်လက် ရှိနေမည်ဖြစ်သည်။
...
> > အမှန်တကယ် သီးခြား workspace/persona များ (“personal” နှင့် “public” ကို လုံးဝ မရောနှောရ) လိုအပ်ပါက၊ second agent + bindings ကို အသုံးပြုပါ။ [Multi-Agent Routing](/concepts/multi-agent) ကို ကြည့်ပါ။
...
“host access မရှိ” အစား “group များသည် folder X ကိုသာ မြင်နိုင်ရမည်” ဟု သတ်မှတ်လိုပါက `workspaceAccess: "none"` ကို ဆက်လက်ထားပြီး allowlist ပြုလုပ်ထားသော path များကိုသာ sandbox ထဲသို့ mount လုပ်ပါ။
...
- Discord: allowlist ကို `channels.discord.guilds.<id>.channels` ဖြင့် အသုံးပြုပါသည်။
- Slack: ခွင့်ပြုစာရင်းတွင် `channels.slack.channels` ကို အသုံးပြုပါသည်။
- Matrix: allowlist ကို `channels.matrix.groups` (room ID များ၊ alias များ သို့မဟုတ် အမည်များ) ဖြင့် အသုံးပြုပါသည်။ ပေးပို့သူများကို ကန့်သတ်ရန် `channels.matrix.groupAllowFrom` ကို အသုံးပြုပါ။ room တစ်ခုချင်းစီအတွက် `users` allowlist များကိုလည်း ပံ့ပိုးထားပါသည်။
