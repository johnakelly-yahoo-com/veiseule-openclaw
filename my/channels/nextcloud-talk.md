...
## အမြန် စတင်ပြင်ဆင်ခြင်း (စတင်သူများအတွက်)
...
4. OpenClaw ကို ဖွဲ့စည်းပြင်ဆင်ပါ:
   - ပြင်ဆင်မှု: `channels.nextcloud-talk.baseUrl` + `channels.nextcloud-talk.botSecret`
...
## လုပ်ဆောင်နိုင်မှုများ

| လုပ်ဆောင်ချက်         | အခြေအနေ        |
| --------------- | ------------- |
