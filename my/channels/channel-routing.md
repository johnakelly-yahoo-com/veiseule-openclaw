...
7. **Channel ကိုက်ညီမှု** (အဆိုပါ channel ပေါ်ရှိ မည်သည့် account မဆို၊ `accountId: "*"`)။
8. **Default agent** (`agents.list[].default`, မဟုတ်ပါက စာရင်းထဲ ပထမဆုံး အချက်အလက်၊ နောက်ဆုံး fallback အဖြစ် `main`)။
