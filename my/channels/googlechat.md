...
3. ရှာဖွေရေးဘားတွင် (လူများကို ထည့်လေ့ရှိသည့် နေရာ) Google Cloud Console တွင် သင် သတ်မှတ်ထားသော **App name** ကို ရိုက်ထည့်ပါ။
   - **မှတ်ချက်**: ဤ bot သည် private app ဖြစ်သောကြောင့် "Marketplace" browse စာရင်းတွင် _မ_ ပေါ်လာပါ။ ၎င်းကို အမည်ဖြင့် ရှာဖွေရပါမည်။
...
> > မှတ်ချက်: ဤ configuration သည် စက်ပြန်ဖွင့်ပြီးနောက်လည်း ဆက်လက်တည်ရှိပါမည်။ နောက်ပိုင်းတွင် ဖယ်ရှားလိုပါက `tailscale funnel reset` နှင့် `tailscale serve reset` ကို 실행ပါ။
