...
- webhook password ကို အမြဲသတ်မှတ်ပါ။ gateway ကို reverse proxy (Tailscale Serve/Funnel, nginx, Cloudflare Tunnel, ngrok) မှတစ်ဆင့် ဖော်ပြပါက proxy သည် loopback မှတစ်ဆင့် gateway သို့ ချိတ်ဆက်နိုင်သည်။ BlueBubbles webhook handler သည် forwarding header များပါရှိသော request များကို proxy မှလာသည်ဟု သတ်မှတ်ပြီး password မပါသော webhook များကို လက်မခံပါ။
...
- `channels.bluebubbles.mediaLocalRoots`: outbound local media path များအတွက် ခွင့်ပြုထားသော absolute local directory များ၏ allowlist ကို တိတိကျကျ သတ်မှတ်သည်။ ဤအရာကို မသတ်မှတ်ထားပါက local path ဖြင့် ပို့ခြင်းများကို ပုံမှန်အားဖြင့် ငြင်းပယ်မည်။ account အလိုက် override - `channels.bluebubbles.accounts.<accountId>.mediaLocalRoots`။
