...
နောက်ဆုံးအပ်ဒိတ်: 2026-01-21

အခြေအနေ: စာသား + DM attachments ကို ပံ့ပိုးထားသည်။ channel/group တွင် ဖိုင်ပို့ရန် `sharePointSiteId` + Graph permissions လိုအပ်သည် (ကြည့်ရန် [Sending files in group chats](#sending-files-in-group-chats))။ Polls များကို Adaptive Cards ဖြင့် ပို့ပါသည်။

## Plugin လိုအပ်သည်

Microsoft Teams သည် plugin အဖြစ် ပို့ဆောင်ပေးထားပြီး core install တွင် မပါဝင်ပါ။

**အရေးကြီးပြောင်းလဲမှု (2026.1.15):** MS Teams ကို core မှ ခွဲထုတ်ထားပါသည်။ အသုံးပြုလိုပါက plugin ကို ထည့်သွင်းရန် လိုအပ်သည်။
...
မှတ်ချက်: group chats များကို မူလအနေဖြင့် ပိတ်ထားပါသည် (`channels.msteams.groupPolicy: "allowlist"`)။ group replies များကို ခွင့်ပြုလိုပါက `channels.msteams.groupAllowFrom` ကို သတ်မှတ်ပါ (သို့မဟုတ် မည်သည့်အဖွဲ့ဝင်မဆို—mention လုပ်ထားမှသာ—ခွင့်ပြုရန် `groupPolicy: "open"` ကို အသုံးပြုပါ)။
