...
**User mentions အတွက် အပိုခွင့်ပြုချက်:** စကားဝိုင်းအတွင်းရှိ user များအတွက် @mentions သည် ပုံမှန်အားဖြင့် အလုပ်လုပ်ပါသည်။ သို့သော် လက်ရှိစကားဝိုင်းတွင် **မပါဝင်သေးသော** user များကို dynamic ရှာဖွေပြီး mention လုပ်လိုပါက `User.Read.All` (Application) permission ကို ထည့်သွင်းပြီး admin consent ပေးရပါမည်။
