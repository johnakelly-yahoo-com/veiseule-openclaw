...
1. ဆက်စပ်: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-openclaw-store-its-data),
...
- ဒါက `main` branch ကို ပြောင်းပြီး source ကနေ update လုပ်ပေးပါတယ်။
...
Windows (PowerShell) နှင့် ကိုက်ညီသော ဥပမာ:
...
`channels.telegram.allowFrom` သည် **လူသားပို့သူ၏ Telegram user ID** (ဂဏန်းပုံစံ) ဖြစ်သည်။ It is not the bot username.

onboarding wizard သည် `@username` ထည့်သွင်းမှုကို လက်ခံပြီး ၎င်းကို ဂဏန်း ID သို့ ပြောင်းလဲပေးနိုင်သော်လည်း OpenClaw authorization သည် ဂဏန်း ID များကိုသာ အသုံးပြုသည်။
...
- Gateway ကို အမြဲဖွင့်ထားသော host (VPS/home server) ပေါ်တွင် chạy ပါ။
- Gateway host နှင့် သင့် computer ကို တူညီသော tailnet ပေါ်တွင် ထားပါ။
- Gateway WS ကို ချိတ်ဆက်နိုင်ကြောင်း သေချာပါ (tailnet bind သို့မဟုတ် SSH tunnel)။
