...
- ကုဒ်လွှမ်းခြုံမှု အတားအဆီး: `pnpm test:coverage`
...
- Pool မှတ်ချက်:
  - OpenClaw သည် ပိုမိုမြန်ဆန်သော unit shard များအတွက် Node 22/23 တွင် Vitest `vmForks` ကို အသုံးပြုသည်။
  - Node 24+ တွင် OpenClaw သည် Node VM linking အမှားများ (`ERR_VM_MODULE_LINK_FAILURE` / `module is already linked`) ကို ရှောင်ရှားရန် ပုံမှန် `forks` သို့ အလိုအလျောက် ပြန်လည်ပြောင်းလဲအသုံးပြုသည်။
  - `OPENCLAW_TEST_VM_FORKS=0` ( `forks` ကို အတင်းအသုံးပြုရန် ) သို့မဟုတ် `OPENCLAW_TEST_VM_FORKS=1` ( `vmForks` ကို အတင်းအသုံးပြုရန် ) ဖြင့် လက်ဖြင့် override လုပ်နိုင်သည်။
...
- Runtime မူလတန်ဖိုးများ:
  ...
  - console I/O overhead ကို လျှော့ချရန် မူလအတိုင်း silent mode ဖြင့် လည်ပတ်သည်။
- မျှော်မှန်းချက်များ:
