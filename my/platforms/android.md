...
## ချိတ်ဆက်မှု လုပ်ဆောင်ချက် လမ်းညွှန် (Runbook)

Android node အက်ပ် ⇄ (mDNS/NSD + WebSocket) ⇄ **Gateway**
...
- Android device/emulator မှ gateway WebSocket ကို ရောက်နိုင်ရပါမည် —
  ...
  - လက်ဖြင့် သတ်မှတ်ထားသော gateway host/port (fallback)
...
မှတ်ချက်៖ node များသည် canvas ကို Gateway HTTP server မှ load လုပ်ပါသည် (`gateway.port` နှင့် တူညီသော port၊ မူလတန်ဖိုး `18789`)။
...
Tailnet (ရွေးချယ်နိုင်သည်)៖ စက်နှစ်လုံးစလုံး Tailscale ပေါ်တွင် ရှိပါက `.local` အစား MagicDNS အမည် သို့မဟုတ် tailnet IP ကို အသုံးပြုနိုင်သည်၊ ဥပမာ `http://<gateway-magicdns>:18789/__openclaw__/canvas/`။

31. ဤ server သည် HTML ထဲသို့ live-reload client ကို inject လုပ်ပြီး ဖိုင်ပြောင်းလဲမှုများရှိပါက reload လုပ်ပါသည်။
    A2UI host သည် `http://<gateway-host>:18789/__openclaw__/a2ui/` တွင် ရှိပါသည်။
