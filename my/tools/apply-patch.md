...
- `tools.exec.applyPatch.workspaceOnly` ၏ ပုံမှန်တန်ဖိုးမှာ `true` ဖြစ်ပြီး (workspace အတွင်းသာ ကန့်သတ်ထားသည်)။ `apply_patch` ကို workspace directory အပြင်ဘက်တွင် ရေးသားရန်/ဖျက်ရန် ရည်ရွယ်ချက်ရှိမှသာ ၎င်းကို `false` ဟု သတ်မှတ်ပါ။
