...
gateway auth ကို ပြင်ဆင်ထားပါက browser HTTP routes များတွင်လည်း auth လိုအပ်ပါသည်။

- `Authorization: Bearer <gateway token>`
- `x-openclaw-password: <gateway password>` သို့မဟုတ် ထို password ဖြင့် HTTP Basic auth
...
- ဒေါင်းလုပ်နှင့် trace output လမ်းကြောင်းများကို OpenClaw ယာယီ root များအတွင်းသာ ကန့်သတ်ထားသည်:
  - traces: `/tmp/openclaw` (fallback: `${os.tmpdir()}/openclaw`)
  - downloads: `/tmp/openclaw/downloads` (fallback: `${os.tmpdir()}/openclaw/downloads`)
- Upload လမ်းကြောင်းများကို OpenClaw ယာယီ uploads root အတွင်းသာ ကန့်သတ်ထားသည်:
