...
title: "Exec အတည်ပြုချက်များ"
---

# Exec အတည်ပြုချက်များ
...
33. `tools.exec.safeBins` သည် **stdin-only** binaries များ (ဥပမာ `jq`) ကို အနည်းငယ် သတ်မှတ်ထားပြီး explicit allowlist entries မလိုအပ်ဘဲ allowlist mode ဖြင့် chạy နိုင်ပါသည်။ 34. Safe bins များသည် positional file args နှင့် path-like tokens များကို ငြင်းပယ်သဖြင့် incoming stream ပေါ်တွင်သာ လုပ်ဆောင်နိုင်ပါသည်။
    Safe bins များသည် execution ပြုလုပ်ချိန်တွင် argv tokens များကို **literal text** အဖြစ်သာ ကိုင်တွယ်ရန် အတင်းအကြပ် သတ်မှတ်သည် (globbing မရှိ
    and `$VARS` expansion မရှိ) stdin-only segments များအတွက်ဖြစ်ပြီး၊ ထို့ကြောင့် `*` သို့မဟုတ် `$HOME/...` ကဲ့သို့သော pattern များကို file read များကို လှည့်ကွက်အသုံးပြုရန် မဖြစ်နိုင်ပါ။
