...
## ထည့်သွင်းခြင်း / ဖွင့်တင်ခြင်း (unpacked)
...
## အသုံးပြုခြင်း (အပို config မလိုပါ)
...
## ချိတ်ဆက် / ဖြုတ်ခြင်း (toolbar ခလုတ်)
...
## မည်သည့် tab ကို ထိန်းချုပ်သနည်း?
