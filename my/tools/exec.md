...
- `host=node` သည် သင်ပို့လိုက်သော non-blocked env override များကိုသာ node သို့ ပို့သည်။ `env.PATH` overrides များကို
  host execution အတွက် ပယ်ချပြီး node hosts များတွင် လျစ်လျူရှုထားသည်။ node တစ်ခုတွင် PATH entries ထပ်မံလိုအပ်ပါက၊
  node host service environment (systemd/launchd) ကို ပြင်ဆင်သတ်မှတ်ပါ သို့မဟုတ် tools များကို စံတည်နေရာများတွင် ထည့်သွင်းပါ။
