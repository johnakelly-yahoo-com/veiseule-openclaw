...
- **Directives**: `/think`, `/verbose`, `/reasoning`, `/elevated`, `/exec`, `/model`, `/queue`။
  ...
  - Directives များကို **authorized senders** များအတွက်သာ အသုံးချမည်။ `commands.allowFrom` ကို သတ်မှတ်ထားပါက ၎င်းတစ်ခုတည်းကိုသာ
    allowlist အဖြစ် အသုံးပြုမည်။ မဟုတ်ပါက authorization ကို channel allowlists/pairing နှင့် `commands.useAccessGroups` မှ ရရှိမည်။
...
- `commands.allowFrom` (optional) သည် command authorization အတွက် provider အလိုက် allowlist ကို သတ်မှတ်ပေးသည်။ သတ်မှတ်ထားပါက၊ ၎င်းသည်
  commands နှင့် directives များအတွက် တစ်ခုတည်းသော authorization အရင်းအမြစ် ဖြစ်ပြီး (channel allowlists/pairing နှင့် `commands.useAccessGroups`
  ကို လျစ်လျူရှုမည်)။ global default အတွက် `"*"` ကို အသုံးပြုပါ။ provider-specific keys များက ၎င်းကို override လုပ်မည်။
- `commands.useAccessGroups` (default `true`) သည် `commands.allowFrom` ကို မသတ်မှတ်ထားပါက commands များအတွက် allowlists/policies များကို အတင်းအကြပ် လိုက်နာစေသည်။
