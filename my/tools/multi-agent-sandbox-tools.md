...
1. level တစ်ခုချင်းစီသည် tools များကို ထပ်မံကန့်သတ်နိုင်သော်လည်း ယခင် level များတွင် ငြင်းပယ်ထားသော tools များကို ပြန်လည်ခွင့်မပြုနိုင်ပါ။
2. `agents.list[].tools.sandbox.tools` ကို သတ်မှတ်ထားပါက ထို agent အတွက် `tools.sandbox.tools` ကို အစားထိုးသုံးမည်ဖြစ်သည်။
3. `agents.list[].tools.profile` ကို သတ်မှတ်ထားပါက ထို agent အတွက် `tools.profile` ကို override လုပ်မည်ဖြစ်သည်။
4. Provider tool keys များသည် `provider` (ဥပမာ `google-antigravity`) သို့မဟုတ် `provider/model` (ဥပမာ `openai/gpt-5.2`) ကို လက်ခံပါသည်။
