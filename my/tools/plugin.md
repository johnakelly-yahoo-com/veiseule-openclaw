...
# ပလပ်အင်များ (တိုးချဲ့အစိတ်အပိုင်းများ)
...
Npm specs များသည် **registry-only** (package name နှင့် optional version/tag) ဖြစ်ရမည်။ Git/URL/file
specs များကို ပယ်ချမည်။
...
- Plugins များသည် Gateway နှင့်အတူ **in‑process** အဖြစ် chạy သဖြင့် trusted code အဖြစ် ဆက်ဆံရမည်။
...
1. `plugins.load.paths` (ဖိုင် သို့မဟုတ် ဒိုင်ရက်ထရီ)

- လုပ်ငန်းခွင် တိုးချဲ့အစိတ်အပိုင်းများ
...
လုံခြုံရေးမှတ်ချက်: `openclaw plugins install` သည် plugin dependencies များကို
`npm install --ignore-scripts` (lifecycle scripts မရှိ) ဖြင့် ထည့်သွင်းသည်။ plugin dependency
trees များကို "pure JS/TS" အဖြစ်ထားရှိပြီး `postinstall` builds လိုအပ်သော packages များကို ရှောင်ကြဉ်ပါ။
...
model provider မဟုတ်ဘဲ **chat surface အသစ်တစ်ခု** ("messaging channel") လိုချင်သည့်အခါ ဤအရာကို အသုံးပြုပါ။
Model provider docs live under `/providers/*`.

1. `meta.label`, `meta.selectionLabel`, `meta.docsPath`, `meta.blurb` တို့သည် CLI/UI စာရင်းများကို ထိန်းချုပ်ပါသည်။
...
- လိုအပ်သလို optional adapters များကို ထည့်ပါ
