...
ဤအရာများသည် **ဘရောက်ဇာ အလိုအလျောက်လုပ်ဆောင်မှု** မဟုတ်ပါ။ JS-heavy ဆိုဒ်များ သို့မဟုတ် လော့ဂ်အင် လိုအပ်သောအရာများအတွက်၊ အသုံးပြုပါ
...
- `web_fetch` သည် ပုံမှန် HTTP GET ကို လုပ်ဆောင်ပြီး ဖတ်ရှုရန် အဆင်ပြေသော အကြောင်းအရာကို ထုတ်ယူသည်
(HTML → markdown/text)။ ၎င်းသည် **JavaScript ကို မလုပ်ဆောင်ပါ**။
- `web_fetch` ကို ပုံမှန်အားဖြင့် ဖွင့်ထားပါသည် (အထူးသဖြင့် ပိတ်မထားလျှင်)။

## ရှာဖွေရေး ပံ့ပိုးသူကို ရွေးချယ်ခြင်း

| ပံ့ပိုးသူ                               | အားသာချက်များ                                   | အားနည်းချက်များ                                      | API Key                                             |
| -------------------------------------- | ----------------------------------------------- | ---------------------------------------------------- | --------------------------------------------------- |
