...
### Shell Helpers (ရွေးချယ်နိုင်သည်)

နေ့စဉ် Docker စီမံခန့်ခွဲမှုကို ပိုမိုလွယ်ကူစေရန် `ClawDock` ကို ထည့်သွင်းပါ:

```bash
mkdir -p ~/.clawdock && curl -sL https://raw.githubusercontent.com/openclaw/openclaw/main/scripts/shell-helpers/clawdock-helpers.sh -o ~/.clawdock/clawdock-helpers.sh
```

**သင့် shell config (zsh) ထဲသို့ ထည့်ပါ:**

```bash
echo 'source ~/.clawdock/clawdock-helpers.sh' >> ~/.zshrc && source ~/.zshrc
```

ထို့နောက် `clawdock-start`, `clawdock-stop`, `clawdock-dashboard` စသည်တို့ကို အသုံးပြုပါ။ အမိန့်များအားလုံးကို ကြည့်ရှုရန် `clawdock-help` ကို လည်ပတ်ပါ။

အသေးစိတ်အတွက် [`ClawDock` Helper README](https://github.com/openclaw/openclaw/blob/main/scripts/shell-helpers/README.md) ကို ကြည့်ပါ။
...
- **system deps များကို image ထဲတွင် bake လုပ်ပါ** (ပြန်လုပ်လို့ရ + တည်မြဲ)—
...
1. **Playwright browser downloads များကို သိမ်းဆည်းထားရန်**—
