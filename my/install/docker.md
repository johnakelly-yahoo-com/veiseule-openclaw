...
Docker သည် **မလိုအပ်ပါ**။ သင်က containerized Gateway တစ်ခုကို အသုံးပြုလိုပါက သို့မဟုတ် Docker flow ကို စမ်းသပ်အတည်ပြုလိုပါကသာ အသုံးပြုပါ။
...
- **မဟုတ်ပါ**: သင်၏ကိုယ်ပိုင်စက်ပေါ်တွင် chạyနေပြီး အမြန်ဆုံး dev loop ကိုသာ လိုချင်ပါက။ ထိုအစား ပုံမှန် install flow ကို အသုံးပြုပါ။
- **Sandboxing မှတ်ချက်**: agent sandboxing သည် Docker ကိုလည်း အသုံးပြုပါသည်၊ သို့သော် Gateway အပြည့်အစုံကို Docker အတွင်းတွင် chạyရန် **မလိုအပ်ပါ**။ [Sandboxing (သီးသန့်ပတ်ဝန်းကျင်ကန့်သတ်ခြင်း)](/gateway/sandboxing) ကို ကြည့်ပါ။
...
## ကွန်တိန်နာပြုလုပ်ထားသော Gateway (Docker Compose)
...
- URL ကို ထပ်မံလိုပါသလား? `docker compose run --rm openclaw-cli dashboard --no-open` ကို chạyပါ။
...
VPS ပေါ်တွင် chạyနေပါသလား? [Hetzner (Docker VPS)](/install/hetzner) ကို ကြည့်ပါ။
