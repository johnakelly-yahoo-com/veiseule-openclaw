...
| `--beta`                        | ရရှိနိုင်ပါက beta dist-tag ကို အသုံးပြုပြီး မရှိပါက `latest` သို့ fallback |
...
<AccordionGroup>
  ...
  <Accordion title="sharp/libvips issues">
    scripts များသည် sharp ကို system libvips နှင့် build မလုပ်စေရန် `SHARP_IGNORE_GLOBAL_LIBVIPS=1` ကို မူလအဖြစ် သတ်မှတ်ထားပါသည်။ override လုပ်ရန်:
  ...
  <Accordion title="Windows: how to get verbose installer output">
    `install.ps1` သည် လက်ရှိတွင် `-Verbose` switch ကို မပံ့ပိုးသေးပါ။
    script-level diagnostics အတွက် PowerShell tracing ကို အသုံးပြုပါ:
