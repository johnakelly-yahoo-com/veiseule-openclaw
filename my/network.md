...
- [Gateway ဗိသုကာ](/concepts/architecture)
- [Gateway ပရိုတိုကော](/gateway/protocol)
- [Gateway လုပ်ငန်းလမ်းညွှန်](/gateway)
- [Web မျက်နှာပြင်များ + bind မုဒ်များ](/web)

## Pairing + အထောက်အထား

- [ချိတ်ဆက်ခြင်း အကျဉ်းချုပ် (DM + node များ)](/channels/pairing)
- [Gateway-owned node ချိတ်ဆက်ခြင်း](/gateway/pairing)
- [Devices CLI (ချိတ်ဆက်ခြင်း + token လှည့်ပြောင်းခြင်း)](/cli/devices)
- [Pairing CLI (DM အတည်ပြုချက်များ)](/cli/pairing)
