...
title: "CLI နောက်ခံစနစ်များ"
---

# CLI နောက်ခံစနစ်များ (fallback runtime)

OpenClaw သည် API providers များ အလုပ်မလုပ်နိုင်သောအခါတွင် **local AI CLIs** များကို **text-only fallback** အဖြစ် လုပ်ဆောင်နိုင်သည်။
...
ဤအရာကို အဓိက အသုံးပြုရန်လမ်းကြောင်းအဖြစ် မဟုတ်ဘဲ **safety net** တစ်ခုအဖြစ် ဒီဇိုင်းပြုလုပ်ထားသည်။ သင် အောက်ပါအခြေအနေများတွင် အသုံးပြုနိုင်သည်။
want “always works” text responses without relying on external APIs.

## စတင်သူများအတွက် လွယ်ကူသော အမြန်စတင်လမ်းညွှန်
...
ဒါပါပဲ။ CLI ကိုယ်တိုင်အပြင် အခြားသော keys သို့မဟုတ် auth configuration မလိုအပ်ပါ။

## Fallback အဖြစ် အသုံးပြုခြင်း
