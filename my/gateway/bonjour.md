...
- Bonjour/mDNS TXT records များသည် **အတည်ပြုမထားသော (unauthenticated)** ဖြစ်သည်။ Clients များသည် TXT ကို authoritative routing အဖြစ် မယူဆသင့်ပါ။
- Clients များသည် ဖြေရှင်းထားသော service endpoint (SRV + A/AAAA) ကို အသုံးပြုပြီး route လုပ်သင့်သည်။ `lanHost`, `tailnetDns`, `gatewayPort`, နှင့် `gatewayTlsSha256` ကို အကြံပြုချက်များ (hints) အဖြစ်သာ သဘောထားပါ။
- TLS pinning တွင် ကြော်ငြာထားသော `gatewayTlsSha256` သည် ယခင် သိမ်းဆည်းထားသော pin ကို မည်သည့်အခါမျှ override မလုပ်စေရ။
- iOS/Android nodes များသည် discovery အခြေပြု direct connect များကို **TLS-only** အဖြစ် သဘောထားပြီး ပထမဆုံး fingerprint ကို ယုံကြည်မည့်အခါ အသုံးပြုသူ၏ ရှင်းလင်းသဘောတူညီချက် လိုအပ်သည်။
