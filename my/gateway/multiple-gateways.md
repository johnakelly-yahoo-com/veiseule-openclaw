...
ပရိုဖိုင်အလိုက် ဝန်ဆောင်မှုများ:
...
- ပရိုဖိုင်/ဖွဲ့စည်းမှု (config)
- state ဖိုလ်ဒါ (state dir)
- အလုပ်လုပ်ရာနေရာ (workspace)
...
## Port မက်ပ်ပင်း (ဆင်းသက်တွက်ချက်ထားသည်)
