...
အောက်ပါ ဥပမာများသည် လက်ရှိ config schema နှင့် ကိုက်ညီအောင် စီစဉ်ထားပါသည်။ အသေးစိတ် ရည်ညွှန်းချက်များနှင့် field တစ်ခုချင်းစီအလိုက် မှတ်ချက်များအတွက် [Configuration](/gateway/configuration) ကို ကြည့်ပါ။
...
> JSON5 သည် comment များနှင့် trailing commas များကို အသုံးပြုနိုင်စေပါသည်။ ပုံမှန် JSON ကိုလည်း အသုံးပြုနိုင်ပါသည်။
...
- Provider ID များသည် ကွဲပြားနိုင်ပါသည် (ဖုန်းနံပါတ်များ၊ user ID များ၊ channel ID များ)။ ဖော်မတ်ကို အတည်ပြုရန် provider ၏ documentation ကို အသုံးပြုပါ။
