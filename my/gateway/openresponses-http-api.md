...
- Request များကို ကာကွယ်ထားသည် (DNS resolution, private IP blocking, redirect caps, timeouts)။
- input အမျိုးအစားတစ်ခုချင်းစီအလိုက် optional hostname allowlist များကို ပံ့ပိုးထားပါသည် (`files.urlAllowlist`, `images.urlAllowlist`)။
  - Exact host: "cdn.example.com"
  - Wildcard subdomains: "\*.assets.example.com" (apex ကို မကိုက်ညီပါ)
...
- URL allowlist များကို fetch မလုပ်မီနှင့် redirect hop များတွင်လည်း စစ်ဆေးအတည်ပြုပါသည်။
- hostname တစ်ခုကို allowlist ထဲ ထည့်သွင်းခြင်းသည် private/internal IP ပိတ်ဆို့မှုကို ကျော်လွှားစေမည် မဟုတ်ပါ။
- အင်တာနက်မှ တိုက်ရိုက်အသုံးပြုနိုင်သော gateway များအတွက် app-level ကာကွယ်မှုများအပြင် network egress control များကိုလည်း အသုံးပြုပါ။
