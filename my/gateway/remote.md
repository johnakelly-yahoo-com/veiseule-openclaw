...
- **Tailscale Serve** သည် `gateway.auth.allowTailscale: true` ဖြစ်သည့်အခါ identity headers များကို အသုံးပြု၍ authenticate ပြုလုပ်နိုင်သည်။
tokens/passwords များကို အသုံးပြုလိုပါက ၎င်းကို `false` ဟု သတ်မှတ်ပါ။
