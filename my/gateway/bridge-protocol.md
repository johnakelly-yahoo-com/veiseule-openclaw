...
TLS ကို ဖွင့်ထားပါက discovery TXT records များတွင် `bridgeTls=1` နှင့်အတူ
`bridgeTlsSha256` ကို လျှို့ဝှက်မဟုတ်သော hint အဖြစ် ထည့်သွင်းပါသည်။ Bonjour/mDNS TXT records များသည်
အတည်ပြုမထားသော (unauthenticated) ဖြစ်ကြောင်း သတိပြုပါ; clients များသည် ကြော်ငြာထားသော fingerprint ကို
အသုံးပြုသူ၏ ရှင်းလင်းသဘောတူညီချက် သို့မဟုတ် အခြား out-of-band အတည်ပြုချက် မရှိဘဲ authoritative pin အဖြစ် မယူဆသင့်ပါ။
