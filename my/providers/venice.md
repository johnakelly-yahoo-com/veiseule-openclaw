...
Venice AI သည် ကိုယ်ရေးကိုယ်တာကို အဓိကထားသော AI inference ဝန်ဆောင်မှုကို ပံ့ပိုးပေးပြီး စိစစ်မထားသော မော်ဒယ်များကို ထောက်ပံ့သည့်အပြင် ၎င်းတို့၏ အမည်မဖော်ပြသော proxy မှတစ်ဆင့် အဓိက proprietary မော်ဒယ်များကိုလည်း အသုံးပြုနိုင်ပါသည်။ Inference အားလုံးကို မူလအနေဖြင့် ကိုယ်ရေးကိုယ်တာကာကွယ်မှုဖြင့် လုပ်ဆောင်ပါသည် — သင့်ဒေတာကို လေ့ကျင့်ရေးအတွက် မသုံးပါ၊ မှတ်တမ်းမတင်ပါ။

## OpenClaw တွင် Venice ကို အသုံးပြုရသည့် အကြောင်းရင်း
...
## ကိုယ်ရေးကိုယ်တာ မုဒ်များ

Venice သည် ကိုယ်ရေးလုံခြုံမှု အဆင့်နှစ်မျိုးကို ပေးထားပြီး — မော်ဒယ်ရွေးချယ်ရာတွင် ယင်းကို နားလည်ထားခြင်း အရေးကြီးသည်။

| မုဒ်           | ဖော်ပြချက်                                                                                                                                                             | မော်ဒယ်များ                                                         |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| **ကိုယ်ရေးကိုယ်တာ**    | အပြည့်အဝ ကိုယ်ရေးကိုယ်တာ။ Prompts/တုံ့ပြန်ချက်များကို **လုံးဝ မသိမ်းဆည်းပါ သို့မဟုတ် မှတ်တမ်းမတင်ပါ**။ ယာယီအသုံးပြုမှုသာ ဖြစ်သည်။                                             | Llama, Qwen, DeepSeek, Venice Uncensored, etc. |
