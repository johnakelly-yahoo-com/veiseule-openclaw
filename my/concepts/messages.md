...
- ချန်နယ်အလိုက် override များ (`channels.whatsapp.*`, `channels.telegram.*`, စသည်) ကို caps နှင့် streaming toggle များအတွက် အသုံးပြုနိုင်သည်။
...
ချန်နယ်များသည် reconnect ပြန်လုပ်ပြီးနောက် တူညီသော မက်ဆေ့ချ်ကို ထပ်မံပို့နိုင်သည်။ OpenClaw သည် ထိန်းသိမ်းထားသည်။
...
ကိရိယာများ/ချန်နယ်များ အများအပြားသည် session တစ်ခုတည်းသို့ ချိတ်ဆက်နိုင်သော်လည်း history ကို အပြည့်အဝ မရရှိနိုင်ပါ။
...
- `Body`- agent သို့ ပို့သော prompt စာသား။ ၎င်းတွင် ချန်နယ် envelope များနှင့် ပါဝင်နိုင်သည်။
ရွေးချယ်နိုင်သော history wrapper များ။
...
**တိုက်ရိုက်မဟုတ်သော chat များ** (group/channel/room များ) အတွက် **လက်ရှိ မက်ဆေ့ချ် body** ကို အောက်ပါအတိုင်း prefix ထည့်ပေးသည်။
...
Block streaming သည် model မှ စာသား block များ ထုတ်လုပ်သလို partial reply များကို ပို့ပေးသည်။
