---
title: "အေးဂျင့် လည်ပတ်စက်ဝန်း"
---

# အေးဂျင့် လည်ပတ်စက်ဝန်း (OpenClaw)
...
4. `subscribeEmbeddedPiSession` သည် pi-agent-core ဖြစ်ရပ်များကို OpenClaw `agent` စီးကြောင်းသို့ ချိတ်ဆက်ပေးသည်။
   - tool ဖြစ်ရပ်များ => `stream: "tool"`
   - assistant အပြောင်းအလဲများ => `stream: "assistant"`
   - lifecycle ဖြစ်ရပ်များ => `stream: "lifecycle"` (`phase: "start" | "end" | "error"`)
...
## တန်းစီခြင်း + ပြိုင်တူလုပ်ဆောင်မှု
...
### အတွင်းပိုင်း ချိတ်ဆက်ချက်များ (Gateway hooks)
