---
title: "အေးဂျင့်များစွာ လမ်းကြောင်းသတ်မှတ်ခြင်း"
status: active
---

# အေးဂျင့်များစွာ လမ်းကြောင်းသတ်မှတ်ခြင်း

ရည်ရွယ်ချက် - Gateway တစ်ခုတည်းကို လည်ပတ်နေစဉ်အတွင်း _သီးခြားခွဲထားသော_ အေးဂျင့်များ (သီးခြား workspace + `agentDir` + sessions) အများအပြားနှင့် channel အကောင့်များစွာ (ဥပမာ - WhatsApp နှစ်ခု) ကို အသုံးပြုနိုင်ရန်။ အဝင် (inbound) မက်ဆေ့ချ်များကို bindings များမှတစ်ဆင့် အေးဂျင့်တစ်ခုသို့ လမ်းကြောင်းသတ်မှတ်ပို့ဆောင်သည်။
...
Auth profile များကို **အေးဂျင့်တစ်ခုချင်းစီအလိုက်** သီးခြားထားရှိသည်။ အေးဂျင့်တိုင်းသည် မိမိ၏ အောက်ပါတို့မှ ဖတ်ယူသည်-

```
~/.openclaw/agents/<agentId>/agent/auth-profiles.json
```

အဓိက အေးဂျင့်၏ အထောက်အထားများကို **အလိုအလျောက်** မျှဝေမထားပါ။ `agentDir` ကို မည်သည့်အခါမျှ ပြန်လည်မသုံးပါနှင့်။
across agents (it causes auth/session collisions). If you want to share creds,
copy `auth-profiles.json` into the other agent's `agentDir`.

Skills များကို workspace တစ်ခုချင်းစီ၏ `skills/` ဖိုလ်ဒါမှတစ်ဆင့် အေးဂျင့်အလိုက် သတ်မှတ်ထားပြီး shared skills များလည်း ပါဝင်နိုင်သည်။
...
### အေးဂျင့်တစ်ခုတည်း မုဒ် (မူလသတ်မှတ်ချက်)
