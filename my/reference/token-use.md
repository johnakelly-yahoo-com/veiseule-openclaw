...
- Workspace + bootstrap ဖိုင်များ (`AGENTS.md`, `SOUL.md`, `TOOLS.md`, `IDENTITY.md`, `USER.md`, `HEARTBEAT.md`, အသစ်ဖြစ်ပါက `BOOTSTRAP.md`, ထို့အပြင် ရှိပါက `MEMORY.md` နှင့်/သို့မဟုတ် `memory.md`)။ ကြီးမားသော ဖိုင်များကို `agents.defaults.bootstrapMaxChars` (မူလတန်ဖိုး: 20000) ဖြင့် ဖြတ်တောက်ထားပြီး၊ bootstrap injection စုစုပေါင်းကို `agents.defaults.bootstrapTotalMaxChars` (မူလတန်ဖိုး: 24000) ဖြင့် ကန့်သတ်ထားသည်။ `memory/*.md` ဖိုင်များကို memory tools များမှ လိုအပ်သည့်အချိန်တွင်သာ ခေါ်ယူအသုံးပြုနိုင်ပြီး အလိုအလျောက် ထည့်သွင်းမထားပါ။
