...
3. **Provider ကီးများ** (OpenAI → Groq → Deepgram → Google)
...
### Provider + CLI အရန်အသုံးပြုမှု (OpenAI + Whisper CLI)
...
အဖွဲ့ချတ်တစ်ခုအတွက် `requireMention: true` ကို သတ်မှတ်ထားပါက၊ OpenClaw သည် mention များကို စစ်ဆေးမီ အသံဖိုင်ကို **အရင်ဆုံး** စာသားပြောင်းလဲ (transcribe) ပြုလုပ်ပါသည်။ ဤလုပ်ဆောင်ချက်ကြောင့် mention ပါဝင်သည့် voice note များကိုလည်း ဆောင်ရွက်နိုင်ပါသည်။

**အလုပ်လုပ်ပုံ:**

1. Voice message တွင် စာသားမပါရှိဘဲ အဖွဲ့က mention လိုအပ်ပါက၊ OpenClaw သည် "preflight" transcription ကို ပြုလုပ်ပါသည်။
2. ရရှိလာသော transcript ကို mention ပုံစံများ (ဥပမာ `@BotName`, emoji trigger များ) အတွက် စစ်ဆေးပါသည်။
3. Mention တွေ့ရှိပါက မက်ဆေ့ချ်ကို ပြည့်စုံသော reply pipeline မှတစ်ဆင့် ဆက်လက်လုပ်ဆောင်ပါသည်။
4. Voice note များ mention စစ်ဆေးမှုကို ဖြတ်ကျော်နိုင်ရန် transcript ကို mention စစ်ဆေးရာတွင် အသုံးပြုပါသည်။

**Fallback လုပ်ဆောင်ပုံ:**

- Preflight အတွင်း transcription မအောင်မြင်ပါက (timeout, API အမှား စသည်ဖြင့်) မက်ဆေ့ချ်ကို စာသားသာအခြေခံ၍ mention စစ်ဆေးသည့် နည်းလမ်းဖြင့် ဆက်လက်လုပ်ဆောင်ပါသည်။
- ဤနည်းလမ်းကြောင့် ပေါင်းစပ်မက်ဆေ့ချ်များ (text + audio) ကို မှားယွင်းစွာ ပယ်ဖျက်ခြင်း မဖြစ်စေရန် အာမခံပါသည်။

**ဥပမာ:** အသုံးပြုသူတစ်ဦးသည် `requireMention: true` သတ်မှတ်ထားသော Telegram အဖွဲ့တွင် "Hey @Claude, what's the weather?" ဟု ပြောသော voice note တစ်စောင် ပေးပို့ပါသည်။ Voice note ကို စာသားပြောင်းလဲပြီး mention ကို ရှာဖွေတွေ့ရှိသဖြင့် အေးဂျင့်က ပြန်ကြားပါသည်။
