...
| စွမ်းဆောင်ရည် | ပံ့ပိုးသူ ပေါင်းစည်းမှု                                    | မှတ်ချက်များ                                                           |
| ---------- | ------------------------------------------------------- | ---------------------------------------------------------------------- |
| ရုပ်ပုံ      | OpenAI / Anthropic / Google / `pi-ai` မှတဆင့် အခြားများ | registry ထဲရှိ image-capable မော်ဒယ် မည်သည့်အရာမဆို အလုပ်လုပ်နိုင်သည်။ |
| အသံ      | OpenAI, Groq, Deepgram, Google                          | Provider transcription (Whisper/Deepgram/Gemini)    |
| ဗီဒီယို      | Google (Gemini API)                  | Provider video နားလည်မှု                                               |
