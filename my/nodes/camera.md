...
- Android ဆက်တင် မျက်နှာပြင် → **ကင်မရာ** → **ကင်မရာကို ခွင့်ပြုရန်** (`camera.enabled`)
  - ပုံမှန်: **အဖွင့်** (ကီး မရှိပါက ခွင့်ပြုထားသည်ဟု သတ်မှတ်မည်)။
  - ပိတ်ထားပါက: `camera.*` အမိန့်များသည် `CAMERA_DISABLED` ကို ပြန်ပို့မည်။
...
- **ဆက်တင် → အထွေထွေ → ကင်မရာကို ခွင့်ပြုရန်** (`openclaw.cameraEnabled`) (`openclaw.cameraEnabled`)
  - ပုံမှန်: **ပိတ်**
