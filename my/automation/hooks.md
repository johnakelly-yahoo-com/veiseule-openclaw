---
summary: "Hooks: အဖြစ်အပျက်အခြေပြု အလိုအလျောက်လုပ်ဆောင်မှုများကို command များနှင့် lifecycle အဖြစ်အပျက်များအတွက် အသုံးပြုရန်"
read_when:
...
Npm specs များသည် registry-only ဖြစ်သည် (package အမည် + ရွေးချယ်နိုင်သော version/tag). Git/URL/file specs များကို လက်မခံပါ.
...
လုံခြုံရေး မှတ်ချက်: `openclaw hooks install` သည် dependency များကို `npm install --ignore-scripts` ဖြင့် ထည့်သွင်းသည်
(lifecycle scripts မပါ). hook pack dependency tree များကို "pure JS/TS" အဖြစ် ထားရှိပြီး `postinstall` builds အပေါ် မူတည်သော package များကို ရှောင်ကြဉ်ပါ.
...
---
name: my-hook
description: "ဤ hook ၏ လုပ်ဆောင်ချက် အကျဉ်းချုပ်"
...
အသေးစိတ် အချက်အလက်များကို ဤနေရာတွင် ရေးသားပါ...

## What It Does

- `/new` command များကို နားထောင်သည်
- အချို့ လုပ်ဆောင်ချက်ကို ဆောင်ရွက်သည်
- ရလဒ်ကို မှတ်တမ်းတင်သည်

## Requirements

- Node.js ကို ထည့်သွင်းထားရမည်
...
မှတ်ချက်: `module` သည် workspace-relative path ဖြစ်ရမည်။ Absolute path များနှင့် workspace ပြင်ပသို့ သွားရောက်သော traversal များကို လက်မခံပါ။
...
`agent:bootstrap` အတွင်း (ဥပမာ monorepo-local `AGENTS.md` / `TOOLS.md`) ကဲ့သို့သော bootstrap ဖိုင်များကို ထပ်မံ ထည့်သွင်းပေးသည်။

**Events**: `agent:bootstrap`

**Requirements**: `workspace.dir` ကို configuration ပြုလုပ်ထားရမည်

**Output**: ဖိုင် မရေးသားပါ; bootstrap context ကို memory အတွင်းသာ ပြင်ဆင်သည်။
...
- Path များကို workspace အပေါ် မူတည်၍ ဖြေရှင်းသည်။
- ဖိုင်များသည် workspace အတွင်းတွင်သာ ရှိရမည် (realpath ဖြင့် စစ်ဆေးထားသည်).
- အသိအမှတ်ပြုထားသော bootstrap basename များကိုသာ load လုပ်သည်။
- Subagent allowlist ကို ထိန်းသိမ်းထားသည် (`AGENTS.md` နှင့် `TOOLS.md` သာ).
...
**လိုအပ်ချက်များ**: `workspace.dir` ကို configure လုပ်ထားရမည်
