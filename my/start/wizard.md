...
1. **Model/Auth** — Anthropic API key (အကြံပြုထားသည်), OpenAI သို့မဟုတ် Custom Provider (OpenAI-compatible, Anthropic-compatible, သို့မဟုတ် Unknown auto-detect)। Default model ကို ရွေးချယ်ပါ။
...
- Onboarding အကျဉ်းချုပ်: [Onboarding Overview](/start/onboarding-overview)
