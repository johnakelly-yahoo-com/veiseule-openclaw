...
<AccordionGroup>
  ...
  <Accordion title="Custom provider">
    ...
    - `--custom-base-url`
    - `--custom-model-id`
    - `--custom-api-key` (ရွေးချယ်နိုင်သည်; မထည့်သွင်းပါက `CUSTOM_API_KEY` ကို အသုံးပြုမည်)
    - `--custom-provider-id` (ရွေးချယ်နိုင်သည်)
    - `--custom-compatibility <openai|anthropic>` (ရွေးချယ်နိုင်သည်; ပုံမှန်တန်ဖိုးမှာ `openai`)
    ```
