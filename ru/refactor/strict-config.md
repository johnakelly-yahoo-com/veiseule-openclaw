...
- Неизвестные ключи считаются ошибками валидации (передача произвольных полей не допускается ни на корневом, ни на вложенных уровнях), за исключением корневого `$schema`, если он является строкой.
