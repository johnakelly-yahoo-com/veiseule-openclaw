...
flowchart TB
    A["<b>Ваш телефон (личный)<br></b><br>Ваш WhatsApp<br>+1-555-YOU"] -- сообщение --> B["<b>Второй телефон (ассистент)<br></b><br>WA ассистента<br>+1-555-ASSIST"]
    B -- связан через QR --> C["<b>Ваш Mac (openclaw)<br></b><br>Агент Pi"]
```
