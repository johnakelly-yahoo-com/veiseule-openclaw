...
Когда для группового чата установлено `requireMention: true`, OpenClaw теперь транскрибирует аудио **до** проверки упоминаний. Это позволяет обрабатывать голосовые сообщения, даже если они содержат упоминания.
