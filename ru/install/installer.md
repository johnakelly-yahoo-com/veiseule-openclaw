...
<Note>
<Note>Если установка прошла успешно, но `openclaw` не найден в новом терминале, см. [устранение неполадок Node.js](/install/node#troubleshooting).
</Note></Note>
...
| Флаг                                              | Описание                                                                                                                               |
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| \`--install-method npm\\                        | Выбор метода установки (по умолчанию: `npm`). Псевдоним: `--method` |
| `--npm`                                           | Быстрый выбор метода npm                                                                                                               |
| `--git`                                           | Быстрый выбор метода git. Псевдоним: `--github`                                                        |
| \`--version <version\\ | Версия npm или dist-tag (по умолчанию: `latest`)                                                    |
...
| Переменная                                                                                         | Описание                                                                                   |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| \`OPENCLAW_INSTALL_METHOD=git\\                        | Метод установки                                                                            |
| \`OPENCLAW_VERSION=latest\\                                                 | Версия npm или dist-tag                                                                    |
| \`OPENCLAW_BETA=0\\                                                         | Использовать beta при наличии                                                              |
| `OPENCLAW_GIT_DIR=&lt;path&gt;`                                                                          | Каталог checkout                                                                           |
| \`OPENCLAW_GIT_UPDATE=0\\                              | Переключение обновлений git                                                                |
...
| \`OPENCLAW_NPM_LOGLEVEL=error\\                        | Уровень логирования npm                                                                    |
| \`SHARP_IGNORE_GLOBAL_LIBVIPS=0\\ | Управление поведением sharp/libvips (по умолчанию: `1`) |
...
| Флаг                     | Описание                                                                                      |
| ------------------------ | --------------------------------------------------------------------------------------------- |
| \`-InstallMethod npm\\ | Метод установки (по умолчанию: `npm`)                      |
...
<AccordionGroup>
  ...
  <Accordion title="Windows: how to get verbose installer output">
    `install.ps1` в настоящее время не поддерживает ключ `-Verbose`.
