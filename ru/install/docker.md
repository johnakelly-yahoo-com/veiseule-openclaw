...
Затем используйте `clawdock-start`, `clawdock-stop`, `clawdock-dashboard` и т.д. Выполните `clawdock-help`, чтобы увидеть все команды.

Подробности см. в [`ClawDock` Helper README](https://github.com/openclaw/openclaw/blob/main/scripts/shell-helpers/README.md).
