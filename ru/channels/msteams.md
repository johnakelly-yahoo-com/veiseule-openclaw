...
2. Заполните вкладку **Basics**:
   ...
   | **Ценовой уровень** | **Free** для разработки/тестирования                                                       |
   | **Тип приложения**  | **Single Tenant** (рекомендуется — см. примечание ниже) |
   | **Тип создания**    | **Create new Microsoft App ID**                                                            |
...
**Дополнительное разрешение для упоминаний пользователей:** Упоминания @пользователей работают из коробки для участников текущего диалога. Однако, если вы хотите динамически искать и упоминать пользователей, которые **не находятся в текущем диалоге**, добавьте разрешение `User.Read.All` (Application) и предоставьте согласие администратора.
