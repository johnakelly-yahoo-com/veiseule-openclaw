...
`bridgeTlsSha256`, чтобы узлы могли закрепить сертификат. Обратите внимание, что Bonjour/mDNS TXT-записи являются
unauthenticated; клиенты не должны считать рекламируемый отпечаток
авторитетным пином без явного намерения пользователя или иной внеполосной проверки.
