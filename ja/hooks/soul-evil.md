...
SOUL Evil フックは、パージウィンドウ中またはランダムな確率によって、**注入された** `SOUL.md` コンテンツを `SOUL_EVIL.md` に入れ替えます。ディスク上のファイルは**変更しません**。 ディスク上のファイルを **変更**しません\*\* 。 ディスク上のファイルを **変更**しません\*\* 。
...
OpenClawは警告をログに記録し、通常の `SOUL.md` を保持します。 `SOUL_EVIL.md` が見つからないか空の場合、
