...
ワイドエリアディスカバリ(Tailscale + CoreDNS)のためのDNSヘルパー。 ワイドエリアディスカバリ(Tailscale + CoreDNS)のためのDNSヘルパー。 広域ディスカバリー向けの DNS ヘルパー（Tailscale + CoreDNS）です。現在は macOS + Homebrew CoreDNS に重点を置いています。
