...
を使用します。 Z.AI コンソールで API キーを作成します。 Z.AI は **GLM** モデル向けの API プラットフォームです。GLM 用の REST API を提供し、認証には API キーを使用します。Z.AI コンソールで API キーを作成してください。OpenClaw は Z.AI の API キーとともに `zai` プロバイダーを使用します。 GLMにRESTAPIを提供し、認証にAPIキー
