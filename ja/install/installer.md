...
| フラグ                                               | 説明                                                                                                                                              |
| ------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| \`--install-method npm\\                        | インストール メソッドを選択（デフォルト: `npm`）。別名: `--method` エイリアス: `--method` エイリアス: `--method` |
| `--npm`                                           | npm メソッドのショートカット                                                                                                                                |
| `--git`                                           | git メソッドのショートカット。別名: `--github` Alias: `--github` Alias: `--github`                             |
| \`--version <version\\ | npm バージョンまたは dist-tag（デフォルト: `latest`）                                                                                          |
| `--beta`                                          | 利用可能であれば beta の dist-tag を使用し、なければ `latest` にフォールバック                                                                                            |
| `--git-dir &lt;path&gt;`                                | チェックアウト ディレクトリ（デフォルト: `~/openclaw`）。別名: `--dir` Alias: `--dir` Alias: `--dir`   |
...
| 変数                                                                                                 | 説明                                               |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| \`OPENCLAW_INSTALL_METHOD=git\\                        | インストール メソッド                                      |
| \`OPENCLAW_VERSION=latest\\                                                 | npm バージョンまたは dist-tag                            |
| \`OPENCLAW_BETA=0\\                                                         | 利用可能であれば beta を使用                                |
| `OPENCLAW_GIT_DIR=&lt;path&gt;`                                                                          | チェックアウト ディレクトリ                                   |
| \`OPENCLAW_GIT_UPDATE=0\\                              | git 更新の切り替え                                      |
...
| \`OPENCLAW_NPM_LOGLEVEL=error\\                        | npm ログ レベル                                       |
| \`SHARP_IGNORE_GLOBAL_LIBVIPS=0\\ | sharp/libvips の挙動を制御（デフォルト: `1`） |
...
| フラグ                      | 説明                                                               |
| ------------------------ | ---------------------------------------------------------------- |
| \`-InstallMethod npm\\ | インストール メソッド（デフォルト: `npm`）                        |
...
<AccordionGroup>
  ...
  <Accordion title="Windows: how to get verbose installer output">
    ...
    スクリプトレベルの診断にはPowerShellのトレースを使用してください：
