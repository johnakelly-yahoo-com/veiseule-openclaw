...
すでに [Getting Started](/start/getting-started) を完了しましたか？ すべて設定されています — このページは、代替のインストール方法、プラットフォーム固有の手順、およびメンテナンスのためのものです。
...
<Tip>
**インストーラースクリプト**は、OpenClaw をインストールする推奨方法です。Node の検出、インストール、オンボーディングを 1 つのステップで処理します。
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="From source" icon="github">
    ...
    より高度な開発ワークフローについては、[Setup](/start/setup) を参照してください。
