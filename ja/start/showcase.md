...
コミュニティからの実際のプロジェクト。 コミュニティによる実際のプロジェクトです。OpenClaw で人々が何を構築しているのかをご覧ください。 コミュニティによる実際のプロジェクトです。OpenClaw で人々が何を構築しているのかをご覧ください。
...
「ロビー」（@openclaw）に地元のワインセラーのスキルを尋ねられました。 ローカルのワインセラー Skill を「Robby」（@openclaw）に依頼。サンプルの CSV エクスポートと保存場所を尋ね、Skill を迅速に構築・テストします（例では 962 本）。 ローカルのワインセラー Skill を「Robby」（@openclaw）に依頼。サンプルの CSV エクスポートと保存場所を尋ね、Skill を迅速に構築・テストします（例では 962 本）。
...
毎週の食事プラン → 定期的な → 本の配送スロット → 注文の確認 APIはありません。ブラウザのコントロールだけです。 APIはありません。ブラウザのコントロールだけです。
...
</Card> マウス座標を使用して、信頼性の高いテーブルセルをクリックします。 
</Card> マウス座標を使用して、信頼性の高いテーブルセルをクリックします。 
</Card>
...
</Card> 端末から問題、プロジェクト、およびワークフローを管理します。 最初の外部PRをマージしました！ 
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli` `automation`

Beer Desktop を使用してメッセージを読み、送信、およびアーカイブします。 Beer Desktop を使用してメッセージを読み、送信、およびアーカイブします。 Beeper Desktop 経由でメッセージの閲覧、送信、アーカイブ。Beeper の local MCP API を使用し、エージェントが iMessage、WhatsApp などすべてのチャットを一元管理できます。 
</Card> 1つの場所で 
</Card> 1つの場所で 
</Card>
...
電子メールからPDFを収集し、税務コンサルタント用の書類を準備します。 自動操縦装置の毎月の会計。 
</Card> 自動操縦装置の毎月の会計。 
</Card>
...
</Card> JSearch APIを使用して30分で構築されました。 
</Card>
...
時計会社のSlackチャンネルは、便利に応答し、Telegramに通知を転送します。 要求されることなく、展開されたアプリでプロダクションのバグを自動的に修正しました。 
</Card> 要求されることなく、展開されたアプリでプロダクションのバグを自動的に修正しました。 
</Card>
...
完全な天文学ギアマーケットプレイス。 OpenClawエコシステムとの間で構築されました。 
</Card>
...
共有したいものがありますか？ぜひご紹介させてください。 特集したいと思います! 特集したいと思います!
