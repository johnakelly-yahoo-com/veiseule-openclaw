...
1つのゲートウェイ以下の14人以上のエージェントで、Opus 4.5オーケストラがCodexワーカーに委任します。 ドリームチームの名簿、モデル選択、サンドボックス化、Webhooks、ハートビート、委任をカバーする包括的な[テクニカルな書き込み](https://github.com/adam91holt/orchestrated-ai-articles)が流れます。 エージェントのサンドボックス化のための [Clawdspace](https://github.com/adam91holt/clawdspace) 14. [ブログ記事](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/)。 
</Card>
...
Beer Desktop を使用してメッセージを読み、送信、およびアーカイブします。 Beeper Desktop 経由でメッセージの閲覧、送信、アーカイブ。Beeper の local MCP API を使用し、エージェントが iMessage、WhatsApp などすべてのチャットを一元管理できます。 
</Card> 1つの場所で 
</Card>
