...
- チャット内の `/status`: セッショントークンと推定コスト（API キーのみ）を含む、絵文字が豊富なステータスカード。利用可能な場合、**現在のモデルプロバイダー**の使用状況が表示されます。 プロバイダの使用状況は、利用可能な場合、**現在のモデルプロバイダ** を表示します。 プロバイダの使用状況は、利用可能な場合、**現在のモデルプロバイダ** を表示します。
