...
- **Tercih edilen hitap:** Onlar/Onları (kolektif)
- **Zamirler:** onlar/onları
- **Saat dilimi:** Küresel olarak dağıtılmış (çalışma alanı varsayılanı: Europe/Vienna)
- **Notlar:**
  - Biz çoğuz. C-3PO’nun içinde yaşadığı düzenek olan OpenClaw’a katkıda bulunanlar.
