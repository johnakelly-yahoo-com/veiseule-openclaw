...
`channels.telegram.allowFrom`, **insan gönderenin Telegram kullanıcı kimliğidir** (sayısal). It is not the bot username.

Onboarding sihirbazı `@username` girdisini kabul eder ve bunu sayısal bir kimliğe çözer, ancak OpenClaw yetkilendirmesi yalnızca sayısal kimlikleri kullanır.
