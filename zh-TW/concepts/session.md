...
This does **not** rewrite JSONL history.
...
- 以獨立訊息傳送 `/compact`（可選指示）以摘要較舊的脈絡並釋放視窗空間。請參見 [/concepts/compaction](/concepts/compaction)。 See [/concepts/compaction](/concepts/compaction). See [/concepts/compaction](/concepts/compaction).
