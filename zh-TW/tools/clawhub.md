...
如果你想為 OpenClaw 代理程式加入新能力，ClawHub 是尋找與安裝 Skills 最簡單的方式。你不需要了解後端如何運作。你可以： You do not need to know how the backend works. You do not need to know how the backend works. You can:
...
當你在已登入狀態下執行 `clawhub sync`，CLI 會傳送最小化的快照以計算安裝次數。你可以完全停用此功能： You can disable this entirely: You can disable this entirely:
