...
models for your GitHub account and plan. It provides access to Copilot
...
because it does not require VS Code. This is the **default** and simplest path
because it does not require VS Code.

### 2. Copilot Proxy 外掛（`copilot-proxy`）

使用 **Copilot Proxy** VS Code 擴充功能作為本地橋接。 8. 8. OpenClaw 會與
代理的 `/v1` 端點通訊，並使用你在那裡設定的模型清單。 OpenClaw 會與
