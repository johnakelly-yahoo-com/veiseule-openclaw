...
Windows-installationsprogram (PowerShell):
...
```powershell
# install.ps1 har endnu ikke en dedikeret -Verbose-flag.
Set-PSDebug -Trace 1
...
`channels.telegram.allowFrom` er **afsenderens Telegram-bruger-ID** (numerisk). Det er ikke bot brugernavn.
