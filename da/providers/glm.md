...
GLM er en **modelfamilie** (ikke en virksomhed) tilgængelig via Z.AI platformen. I OpenClaw tilgås GLM-modeller via `zai`-udbyderen og model-ID'er som `zai/glm-5`.
