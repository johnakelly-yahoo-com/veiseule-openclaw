...
| channelInfo     | aktiveret  | Kanalinfo + liste                                     |
| channels        | aktiveret  | Kanal-/kategoristyring                                |
| voiceStatus     | aktiveret  | Voice state-opslag                                    |
| events          | aktiveret  | List/opret planlagte events                           |
| roller           | deaktiveret | Rolle tilføj/fjern                                    |
| moderering      | deaktiveret | Timeout/kick/ban                                      |
| presence        | deaktiveret | Bot-status/aktivitet (setPresence) |
