...
| 플래그                                               | 설명                                                                                                           |
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| \`--install-method npm\\                        | 설치 방법 선택(기본값: `npm`). 별칭: `--method`      |
| `--npm`                                           | npm 방식의 바로 가기                                                                                                |
| `--git`                                           | git 방식의 바로 가기. 별칭: `--github`                                                |
| \`--version <version\\ | npm 버전 또는 dist-tag (기본값: `latest`)                                        |
...
| 변수                                                                                                 | 설명                                                               |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| \`OPENCLAW_INSTALL_METHOD=git\\                        | 설치 방법                                                            |
| \`OPENCLAW_VERSION=latest\\                                                 | npm 버전 또는 dist-tag                                               |
| \`OPENCLAW_BETA=0\\                                                         | 사용 가능하면 beta 사용                                                  |
| `OPENCLAW_GIT_DIR=&lt;path&gt;`                                                                          | 체크아웃 디렉토리                                                        |
| \`OPENCLAW_GIT_UPDATE=0\\                              | git 업데이트 토글                                                      |
| `OPENCLAW_NO_PROMPT=1`                                                                             | 프롬프트 비활성화                                                        |
| `OPENCLAW_NO_ONBOARD=1`                                                                            | 온보딩 건너뛰기                                                         |
| `OPENCLAW_DRY_RUN=1`                                                                               | 드라이 런 모드                                                         |
| `OPENCLAW_VERBOSE=1`                                                                               | 디버그 모드                                                           |
| \`OPENCLAW_NPM_LOGLEVEL=error\\                        | npm 로그 레벨                                                        |
| \`SHARP_IGNORE_GLOBAL_LIBVIPS=0\\ | sharp/libvips 동작 제어(기본값: `1`) |
...
| 플래그                      | 설명                                                                           |
| ------------------------ | ---------------------------------------------------------------------------- |
| \`-InstallMethod npm\\ | 설치 방법(기본값: `npm`)                         |
