...
<Note>
이 페이지는 엄선된 색인입니다. 처음 사용하는 경우 [시작하기](/start/getting-started)부터 시작하십시오.
문서의 전체 맵은 [문서 허브](/start/hubs)를 참고하십시오.
</Note>
...
- [페어링 (다이렉트 메시지 및 노드)](/channels/pairing)
- [Nix 모드](/install/nix)
...
- [Gateway 실행 가이드](/gateway)
- [노드 (iOS 및 Android)](/nodes)
- [웹 서피스 (Control UI)](/web)
- [디바이스 검색 및 전송](/gateway/discovery)
