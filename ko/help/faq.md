...
- [로깅과 디버깅](#logging-and-debugging)
  ...
  - [ELI5: `openclaw gateway restart`와 `openclaw gateway`의 차이](#eli5-openclaw-gateway-restart-vs-openclaw-gateway)
...
이 저장소에서는 소스에서 직접 실행하고 온보딩 마법사를 사용하는 것을 권장합니다:
