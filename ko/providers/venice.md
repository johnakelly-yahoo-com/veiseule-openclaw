...
| 모드             | 설명                                                                                                                               | 모델                                         |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| **비공개**    | 완전 비공개. 프롬프트/응답은 **절대 저장되거나 로깅되지 않습니다**. 일회성입니다.                                 | Llama, Qwen, DeepSeek, Venice Uncensored 등 |
| **익명화됨** | 메타데이터를 제거한 상태로 Venice 를 통해 프록시됩니다. 기본 프로바이더(OpenAI, Anthropic)는 익명화된 요청을 봅니다. | Claude, GPT, Gemini, Grok, Kimi, MiniMax   |
