...
Der Onboarding-Assistent akzeptiert die Eingabe von `@username` und löst diese in eine numerische ID auf, aber die OpenClaw-Autorisierung verwendet ausschließlich numerische IDs.
