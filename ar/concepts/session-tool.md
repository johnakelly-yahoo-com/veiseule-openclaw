...
- يتم حفظ الرسائل بين الجلسات مع `message.provenance.kind = "inter_session"` حتى يتمكن قارئو السجل من تمييز تعليمات الوكيل المُوجَّهة عن مدخلات المستخدم الخارجية.
