...
`bridgeTlsSha256` لكي تتمكن العُقد من تثبيت الشهادة. لاحظ أن سجلات Bonjour/mDNS TXT
غير موثَّقة؛ يجب ألا يتعامل العملاء مع البصمة المُعلَن عنها على أنها
بصمة معتمدة دون نية صريحة من المستخدم أو تحقق آخر خارج النطاق.
