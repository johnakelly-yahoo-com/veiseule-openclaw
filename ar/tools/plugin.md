...
مواصفات Npm تكون **من السجل فقط** (اسم الحزمة + إصدار/وسم اختياري). مواصفات Git/URL/file
مرفوضة.
...
- لا يمكن للإضافات تجاوز أسماء الأوامر المحجوزة (مثل `help`، `status`، `reset`، إلخ) لا يمكن تجاوزها بواسطة الإضافات لا يمكن تجاوزها بواسطة الإضافات
