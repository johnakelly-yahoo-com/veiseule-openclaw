...
تفرض الحاويات الآمنة أيضًا التعامل مع رموز argv كنص **حرفي** عند التنفيذ (بدون globbing
ودون توسيع `$VARS`) للأجزاء التي تعتمد على stdin فقط، بحيث لا يمكن استخدام أنماط مثل `*` أو `$HOME/...`
لتمرير قراءات ملفات بشكل غير مشروع.
