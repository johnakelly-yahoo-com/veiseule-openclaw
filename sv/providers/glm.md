...
GLM är en **modellfamilj** (inte ett företag) som finns tillgänglig via Z.AI-plattformen. I OpenClaw nås GLM-modeller via leverantören `zai` och modell-ID:n som `zai/glm-5`.
