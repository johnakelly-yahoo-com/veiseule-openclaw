...
Om du kör OpenClaw som ett tjänstkonto eller vill ha anpassade platser för konfiguration/tillstånd:

- `OPENCLAW_HOME` anger hemkatalogen som används för intern sökvägsupplösning.
- `OPENCLAW_STATE_DIR` åsidosätter katalogen för tillstånd.
- `OPENCLAW_CONFIG_PATH` åsidosätter sökvägen till konfigurationsfilen.

Fullständig referens för miljövariabler: [Environment vars](/help/environment).
