...
1. **Model/Auth** — Anthropic API-nyckel (rekommenderas), OpenAI eller Custom Provider
   (OpenAI-kompatibel, Anthropic-kompatibel eller Unknown automatisk identifiering). Välj en standardmodell.
