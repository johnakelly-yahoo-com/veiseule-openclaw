...
Automatiserad bokning av skolmåltider i Storbritannien via ParentPay. Använder muskoordinater för tillförlitliga tabellcellklickning. 
</Card>

<Card title="R2 Upload (Send Me My Files)" icon="cloud-arrow-up" href="https://clawhub.com/skills/r2-upload">
  **@julianengel** • `files` `r2` `presigned-urls`

Ladda upp till Cloudflare R2/S3 och generera säkra försignerade nedladdningslänkar. Perfekt för fjärrstyrda OpenClaw-instanser. 
</Card>
...
14+ agenter under en gateway med Opus 4.5 som delegerar till Codex arbetare. Omfattande [teknisk uppskrivning](https://github.com/adam91holt/orchestrated-ai-articles) som täcker Dream Team deltagare, modellval, sandlåda, webhooks, hjärtslag och delegationsflöden. [Clawdspace](https://github.com/adam91holt/clawdspace) för agentsandboxning. [Blogginlägg](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/). 
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`

CLI för Linjär som integrerar med agentic arbetsflöden (Claude Code, OpenClaw). Hantera frågor, projekt och arbetsflöden från terminalen. Första externa PR sammanslagning! 
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli` `automation`

Läs, skicka, och arkivera meddelanden via Beeper Desktop. Använder Beeper lokala MCP API så att agenter kan hantera alla dina chattar (iMessage, WhatsApp, etc.) på ett ställe. 
</Card>
...
En schemalagd prompt genererar en enda "scen"-bild varje morgon (väder, uppgifter, datum, favoritinlägg / citat) via en OpenClaw persona. 
</Card>
...
Hämtar PDF-filer från e-post, preps dokument för skatterådgivare. Månatlig redovisning på autopilot. 
</Card>

<Card title="Couch Potato Dev Mode" icon="couch" href="https://davekiss.com">
  **@davekiss** • `telegram` `website` `migration` `astro`

Ombyggd hela personliga webbplats via Telegram medan du tittar på Netflix — Notion → Astro, 18 inlägg migrerade, DNS till Cloudflare. Aldrig öppnat en bärbar dator. 
</Card>

<Card title="Job Search Agent" icon="briefcase">
  **@attol8** • `automation` `api` `skill`

Söker jobblistor, träffar mot cv-nyckelord och returnerar relevanta möjligheter med länkar. Byggt på 30 minuter med JSearch API. 
</Card>

<Card title="Jira Skill Builder" icon="diagram-project" href="https://x.com/jdrhyne/status/2008336434827002232">
  **@jdrhyne** • `automation` `jira` `skill` `devtools`

OpenClaw ansluten till Jira, genererade sedan en ny färdighet i farten (innan den fanns på ClawHub). 
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automatiserade Todoist uppgifter och hade OpenClaw generera skicklighet direkt i Telegram chatt. 
</Card>

<Card title="TradingView Analysis" icon="chart-line">
  **@bheem1798** • `finance` `browser` `automation`

Loggar in i TradingView via webbläsarautomatisering, skärmdumpar diagram och utför teknisk analys på begäran. Inget API behövs – bara webbläsarkontroll. 
</Card>

<Card title="Slack Auto-Support" icon="slack">
  **@henrymascot** • `slack` `automation` `support`

Klockor företaget Slack kanal, svarar på ett bra sätt och vidarebefordrar meddelanden till Telegram. Automatiskt rättade en produktionsbugg i en distribuerad app utan att bli tillfrågad. 
</Card>
...
Ingests full WhatsApp export, transkriberar 1 k+ röstanteckningar, korskontroller med git loggar, utgångar länkade markdown rapporter. 
</Card>

<Card title="Karakeep Semantic Search" icon="magnifying-glass" href="https://github.com/jamesbrooksco/karakeep-semantic-search">
  **@jamesbrooksco** • `search` `vector` `bookmarks`

Lägger till vektorsökning i Karakeep bokmärken med Qdrant + OpenAI/Ollama inbäddningar. 
</Card>

<Card title="Inside-Out-2 Memory" icon="brain">
  **Community** • `memory` `beliefs` `self-model`

Separat minneshanterare som förvandlar sessionsfiler till minnen → övertygelser → utvecklas själv modell. 
</Card>
...
Vapi röstassistent ↔️ OpenClaw HTTP-brygga. Nära i realtid telefonsamtal med din agent. 
</Card>

<Card title="OpenRouter Transcription" icon="microphone" href="https://clawhub.com/obviyus/openrouter-transcribe">
  **@obviyus** • `transcription` `multilingual` `skill`

Flerspråkig ljudtranskription via OpenRouter (Gemini, etc). Tillgänglig på ClawHub. 
</Card>
...
OpenClaw gateway körs på Home Assistant OS med SSH-tunnelstöd och ihållande tillstånd. 
</Card>

<Card title="Home Assistant Skill" icon="toggle-on" href="https://clawhub.com/skills/homeassistant">
  **ClawHub** • `homeassistant` `skill` `automation`

Styr och automatisera hemassistentenheter via naturligt språk. 
</Card>

<Card title="Nix Packaging" icon="snowflake" href="https://github.com/openclaw/nix-openclaw">
  **@openclaw** • `nix` `packaging` `deployment`

Batterier inkluderade nixified OpenClaw konfiguration för reproducerbara distributioner. 
</Card>

<Card title="CalDAV Calendar" icon="calendar" href="https://clawhub.com/skills/caldav-calendar">
  **ClawHub** • `calendar` `caldav` `skill`

Kalenderskicklighet med hjälp av khal/vdirsyncer. Själv värd kalender integration. 
</Card>
...
Full astronomi redskap marknadsplats. Byggd med/runt OpenClaw ekosystem. 
</Card>
