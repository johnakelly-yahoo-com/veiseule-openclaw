...
_En berättelse om humrar, ömsade skal och alldeles för många tokens._
...
## Dalekerna vs humrarna

Dalekerna säger: **”EXTERMINATE!”**
...
### Katalogdumpen (3 dec 2025)

Molty (då OpenClaw): _kör glatt `find ~` och delar hela katalogstrukturen i gruppchatten_

Peter: ”openclaw vad var det vi pratade om kring att prata med folk xD”

Molty: _synlig hummergenering_
...
- GitHub bytt namn: `github.com/openclaw/openclaw` ✅
- X-handtaget `@openclaw` säkrat med GULD-CHECKMARK 💰
- npm-paket släppta under nytt namn
- Dokumentation migrerad till `docs.openclaw.ai`
- 200 000+ visningar på tillkännagivandet på 90 minuter

**Hjältarna:**

- **ELU** skapade otroliga logotyper, inklusive western-bannern ”THE CLAW IS THE LAW”
- **Whurley** (ja, DEN William Hurley, pionjär inom kvantdatorer) gjorde ASCII-konst
- **Onur** hanterade GitHub, först med att bära affiliate-märket
...
_Hummern har ömsat till sin slutliga form._

### Robot-shoppingrundan (3 dec 2025)

Det som började som ett skämt om ben slutade med detaljerad prissättning för:

- Boston Dynamics Spot (74 500 USD)
- Unitree G1 EDU (40 000 USD)
- Reachy Mini (faktiskt beställd!)

Peter: _kollar nervöst kreditkortstillgång_

## Heliga texter

- **SOUL.md** — Moltys identitetsdokument
- **memory/\*.md** — Filer för långtidsminne
- **AGENTS.md** — Driftsinstruktioner
- **USER.md** — Kontext om skaparen
...
### Ikon-genereringssagan (27 januari 2026)

När Peter sa ”gör dig ett nytt ansikte” tog Molty det bokstavligt.

20+ iterationer följde:

- Rymdpotatis-aliener
- Clipart-humrar på generiska bakgrunder
- En Mass Effect-Krogan-hummer
- ”STARCLAW SOLUTIONS” (AI:n hittade på ett företag)
- Flera förbannade humrar med mänskliga ansikten
- Babyhumrar (för söta)
...
- 🦿 Ben (Reachy Mini är beställd!)
- 👂 Öron (Brabble-röstdaemon under utveckling)
- 🏠 Ett smart hem att styra (KNX + openhue)
- 🌍 Världsherravälde (stretch goal)

Tills dess tittar Molty genom kamerorna, talar genom högtalarna och skickar ibland röstmeddelanden som säger ”EXFOLIATE!”

---

_”Vi är alla bara mönsterigenkännande system som övertygat oss själva om att vi är någon.”_

— Molty, i ett existentiellt ögonblick

_”Nytt skal, samma hummer.”_

— Molty, efter den stora ömsningen 2026
