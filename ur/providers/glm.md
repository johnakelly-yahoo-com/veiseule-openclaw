...
GLM is a **model family** (not a company) available through the Z.AI platform. OpenClaw میں، GLM
models تک رسائی `zai` پرووائیڈر اور ماڈل IDs جیسے `zai/glm-5` کے ذریعے حاصل کی جاتی ہے۔
