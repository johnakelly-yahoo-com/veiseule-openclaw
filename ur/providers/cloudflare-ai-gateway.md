...
- فراہم کنندہ: `cloudflare-ai-gateway`
- بنیادی URL: `https://gateway.ai.cloudflare.com/v1/<account_id>/<gateway_id>/anthropic`
- طے شدہ ماڈل: `cloudflare-ai-gateway/claude-sonnet-4-5`
