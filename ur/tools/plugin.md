...
1. `plugins.load.paths` (فائل یا ڈائریکٹری)

- ورک اسپیس ایکسٹینشنز
...
سیکیورٹی نوٹ: `openclaw plugins install` پلگ اِن کی انحصاریوں کو `npm install --ignore-scripts` (کوئی lifecycle اسکرپٹس نہیں) کے ساتھ انسٹال کرتا ہے۔ پلگ اِن کی dependency
trees کو "pure JS/TS" رکھیں اور ایسے پیکیجز سے گریز کریں جنہیں `postinstall` builds درکار ہوں۔
