...
`openclaw doctor` OpenClaw کے لیے مرمت + مائیگریشن ٹول ہے۔ یہ پرانے کو درست کرتا ہے
...
پرامپٹس کے بغیر چلائیں اور صرف محفوظ مائیگریشنز (کنفیگ نارملائزیشن + ڈسک پر موجود اسٹیٹ کی منتقلیاں) لاگو کریں۔ یہ ری اسٹارٹ/سروس/سینڈ باکس کارروائیوں کو چھوڑ دیتا ہے جن کے لیے انسانی تصدیق درکار ہوتی ہے۔
