...
Gateway کی ملکیت میں ہونے والی جوڑی سازی (pairing) میں، **Gateway** اس بات کا مستند ماخذ ہوتا ہے کہ کون سے نوڈز شامل ہیں۔
...
- **Transport**: Gateway کا WS endpoint درخواستوں کو آگے بھیجتا ہے لیکن فیصلہ نہیں کرتا۔
رکنیت۔ (Legacy TCP bridge سپورٹ کو متروک/ختم کر دیا گیا ہے۔)
