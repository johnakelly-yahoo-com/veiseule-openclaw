...
- **لائیو اسٹریم پیش نظارہ:** اختیاری `channels.telegram.streamMode` ایک عارضی پیغام بھیجتا ہے اور اسے `editMessageText` کے ذریعے اپڈیٹ کرتا ہے۔ This is separate from channel block streaming.
