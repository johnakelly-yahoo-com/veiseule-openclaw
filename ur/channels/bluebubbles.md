...
حیثیت: شامل شدہ پلگ اِن جو HTTP کے ذریعے BlueBubbles macOS سرور سے رابطہ کرتا ہے۔ **iMessage انضمام کے لیے تجویز کردہ** کیونکہ اس کا API زیادہ جامع ہے اور پرانے imsg چینل کے مقابلے میں سیٹ اپ آسان ہے۔

## جائزہ

- macOS پر BlueBubbles ہیلپر ایپ کے ذریعے چلتا ہے ([bluebubbles.app](https://bluebubbles.app)).
- تجویز کردہ/آزمودہ: macOS Sequoia (15)۔ macOS Tahoe (26) کام کرتا ہے؛ تاہم اس وقت Tahoe پر ترمیم (edit) کا فیچر کام نہیں کر رہا، اور گروپ آئیکن کی اپ ڈیٹس کامیاب دکھائی دے سکتی ہیں مگر ہم آہنگ (sync) نہیں ہوتیں۔
