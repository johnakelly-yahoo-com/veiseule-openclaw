...
- ہمیشہ ایک webhook پاس ورڈ سیٹ کریں۔ اگر آپ gateway کو کسی reverse proxy (Tailscale Serve/Funnel، nginx، Cloudflare Tunnel، ngrok) کے ذریعے ایکسپوز کرتے ہیں تو proxy ممکن ہے کہ gateway سے loopback کے ذریعے کنیکٹ کرے۔ BlueBubbles webhook ہینڈلر forwarding headers کے ساتھ آنے والی ریکویسٹز کو proxied سمجھتا ہے اور پاس ورڈ کے بغیر webhooks قبول نہیں کرے گا۔
...
- `channels.bluebubbles.mediaLocalRoots`: آؤٹ باؤنڈ لوکل میڈیا راستوں کے لیے مجاز مطلق لوکل ڈائریکٹریز کی واضح allowlist۔ جب تک یہ کنفیگر نہ کیا جائے، لوکل پاتھ بھیجنا ڈیفالٹ طور پر مسترد ہوتا ہے۔ فی اکاؤنٹ اووررائیڈ: `channels.bluebubbles.accounts.<accountId>.mediaLocalRoots`۔
