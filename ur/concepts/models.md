...
یہ عمل **عام جواب** تیار ہونے سے پہلے ہوتا ہے، اس لیے پیغام محسوس ہو سکتا ہے۔
...
- ماڈل ریفس کو **پہلے** `/` پر تقسیم کر کے پارس کیا جاتا ہے۔ `/model <ref>` ٹائپ کرتے وقت `provider/model` استعمال کریں۔
