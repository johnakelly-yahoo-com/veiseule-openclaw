...
| [`install-cli.sh`](#install-clish) | macOS / Linux / WSL                     | Node + OpenClaw کو ایک لوکل پری فکس (`~/.openclaw`) میں انسٹال کرتا ہے۔ روٹ کی ضرورت نہیں۔             |
...
عموماً PATH کا مسئلہ ہوتا ہے۔ دیکھیں [Node.js خرابیوں کا ازالہ](/install/node#troubleshooting).
