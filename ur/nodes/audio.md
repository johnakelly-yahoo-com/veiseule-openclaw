...
- ڈیفالٹ سائز حد 20MB ہے (`tools.media.audio.maxBytes`)۔ حد سے زیادہ بڑی آڈیو اس ماڈل کے لیے نظر انداز کر دی جاتی ہے اور فہرست میں اگلا اندراج آزمایا جاتا ہے۔
- آڈیو کے لیے ڈیفالٹ `maxChars` **غیر متعین** ہے (مکمل ٹرانسکرپٹ)۔ آؤٹ پٹ کو مختصر کرنے کے لیے `tools.media.audio.maxChars` یا ہر اندراج کے لیے `maxChars` سیٹ کریں۔
