...
3. pag-gate ng pagbanggit (`requireMention`, `/activation`)

## Pag-gate ng pagbanggit (default)
...
2. grupo/channel `tools`
3. default (`"*"`) tugma ng `toolsBySender`
4. naka-default (`"*"`) `tools`
...
## Aktibasyon (para sa may-ari lamang)
