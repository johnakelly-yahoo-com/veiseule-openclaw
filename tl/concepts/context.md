...
- Metadata ng runtime (host/OS/modelo/pag-iisip).
...
Mga Dokumento: [Sesyon](/concepts/session), [Pag-compact](/concepts/compaction), [Pag-trim ng Sesyon](/concepts/session-pruning).
