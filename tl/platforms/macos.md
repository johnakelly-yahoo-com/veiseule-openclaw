...
# OpenClaw macOS Kasamang App (menu bar + tagapamagitan ng gateway)
...
## Build at dev na daloy ng trabaho (native)

- `cd apps/macos && swift build`
- `swift run OpenClaw` (o Xcode)
- I-package ang app: `scripts/package-mac-app.sh`

## I-debug ang koneksyon ng gateway (macOS CLI)
...
## Imprastraktura ng remote na koneksyon (SSH tunnels)
...
### Tunnel ng kontrol (Gateway WebSocket port)
