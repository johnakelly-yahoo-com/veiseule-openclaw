...
GLM is a **model family** (not a company) available through the Z.AI platform. Sa OpenClaw, ang mga modelong GLM ay ina-access sa pamamagitan ng `zai` provider at mga model ID tulad ng `zai/glm-5`.
