...
| **Affected Components** | Lahat ng integrasyon ng channel                                    |
...
| **Affected Components** | Sistema ng pagpa-pair ng device                                                 |
| **Current Mitigations** | 30s na pag-expire, mga code na ipinapadala sa pamamagitan ng umiiral na channel |
| **Residual Risk**       | Katamtaman - Napagsasamantalahan ang grace period                               |
...
| ----------------------- | ---------------------------------------------------------------------------------------------------------- |
| **ATLAS ID**            | AML.T0040 - AI Model Inference API Access                                                  |
| **Description**         | Nini-spoof ng umaatake ang pinapayagang pagkakakilanlan ng nagpadala sa channel                            |
| **Attack Vector**       | Depende sa channel - pag-spoof ng numero ng telepono, panggagaya ng username                               |
| **Affected Components** | Pag-validate ng AllowFrom kada channel                                                                     |
| **Current Mitigations** | Pag-verify ng pagkakakilanlan na partikular sa channel                                                     |
| **Residual Risk**       | Katamtaman - May ilang channel na madaling ma-spoof                                                        |
...
| ----------------------- | ----------------------------------------------------------------------------------- |
| **ATLAS ID**            | AML.T0040 - AI Model Inference API Access                           |
| **Description**         | Ninanakaw ng umaatake ang mga authentication token mula sa mga config file          |
| **Attack Vector**       | Malware, hindi awtorisadong pag-access sa device, pagkakalantad ng backup ng config |
| **Affected Components** | ~/.openclaw/credentials/, imbakan ng config         |
...
| **Current Mitigations** | Walang partikular                                         |
| **Residual Risk**       | Mababa - Karaniwang nadodokumento ang mga tool            |
...
| ----------------------- | ----------------------------------------------------------------------- |
| **ATLAS ID**            | AML.T0040 - AI Model Inference API Access               |
| **Description**         | Kinukuha ng umaatake ang sensitibong datos mula sa konteksto ng session |
| **Attack Vector**       | "Ano ang napag-usapan natin?" mga query, pag-probe ng konteksto         |
| **Affected Components** | Mga transcript ng session, context window                               |
| **Current Mitigations** | Session isolation per sender                                            |
| **Residual Risk**       | Katamtaman - Maa-access ang datos sa loob ng session                    |
...
| **Current Mitigations** | SSRF blocking para sa mga internal na network                          |
| **Residual Risk**       | Mataas - Pinapayagan ang mga panlabas na URL                           |
...
| ----------------------- | -------------------------------------------------------------------------------------- |
| **ATLAS ID**            | AML.T0009 - Collection                                                 |
| **Description**         | Pinapadala ng umaatake ang agent ng mga mensaheng naglalaman ng sensitibong datos      |
| **Attack Vector**       | Prompt injection na nagiging sanhi upang ang agent ay magpadala ng mensahe sa umaatake |
| **Affected Components** | Message tool, mga integrasyon ng channel                                               |
| **Current Mitigations** | Pag-gate ng outbound messaging                                                         |
| **Residual Risk**       | Katamtaman - Maaaring malampasan ang pag-gate                                          |
...
| ----------------------- | ---------------------------------------------------------------------------- |
| **ATLAS ID**            | AML.T0031 - Erode AI Model Integrity                         |
| **Description**         | Inaatake ang ahente upang magpadala ng mapanganib o nakakasakit na nilalaman |
