...
- Patakaran sa coverage: `pnpm test:coverage`
- Suite ng E2E: `pnpm test:e2e`
...
- Saklaw:
  ...
  - Mga in-process na integration test (auth ng gateway, routing, tooling, parsing, config)
