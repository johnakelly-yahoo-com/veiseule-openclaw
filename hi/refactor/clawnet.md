...
- डिफ़ॉल्ट बाइंड: लूपबैक। रिमोट एक्सेस SSH/Tailscale के माध्यम से।
...
- ऑपरेटर के लिए वैकल्पिक **scope**:
  ...
  - `operator.write` (एजेंट रन, भेजता है)
  - `operator.admin` (कॉन्फ़िग, चैनल, मॉडल्स)
...
भूमिका प्रति‑कनेक्शन होती है, प्रति डिवाइस नहीं। एक डिवाइस दोनों भूमिकाएँ अलग‑अलग खोल सकता है।
