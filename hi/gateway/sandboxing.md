...
- जब सेट किया जाता है (जिसमें `[]` शामिल है), तो यह browser container के लिए `agents.defaults.sandbox.docker.binds` को प्रतिस्थापित करता है।
- यदि छोड़ा गया है, तो browser container `agents.defaults.sandbox.docker.binds` पर वापस चला जाता है (backwards compatible)।
