...
- अंतराल: `30m` (या `1h` जब Anthropic OAuth/setup-token को प्रमाणित ऑथ मोड के रूप में पहचाना जाए)। `agents.defaults.heartbeat.every` या प्रति-एजेंट `agents.list[].heartbeat.every` सेट करें; अक्षम करने के लिए `0m` का उपयोग करें।
- प्रॉम्प्ट बॉडी (जिसे `agents.defaults.heartbeat.prompt` के माध्यम से कॉन्फ़िगर किया जा सकता है):
  `Read HEARTBEAT.md if it exists (workspace context). Follow it strictly. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK.`
- हार्टबीट प्रॉम्प्ट उपयोगकर्ता संदेश के रूप में **ज्यों का त्यों** भेजा जाता है। सिस्टम
प्रॉम्प्ट में “Heartbeat” अनुभाग शामिल होता है और रन को आंतरिक रूप से चिह्नित किया जाता है।
- सक्रिय घंटे (`heartbeat.activeHours`) कॉन्फ़िगर किए गए टाइमज़ोन में जाँचे जाते हैं।
इस समयावधि के बाहर, हार्टबीट अगली विंडो के भीतर आने वाले अगले टिक तक छोड़ दिए जाते हैं।
...
- **मानव चेक-इन**: “दिन के समय अपने मानव से कभी-कभी हालचाल पूछें” एक हल्का संकेत देता है
कभी-कभार हल्का “आपको कुछ चाहिए?” संदेश भेजने के लिए, लेकिन रात के समय अनावश्यक संदेशों से बचाता है।
