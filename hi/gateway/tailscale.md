...
OpenClaw, के लिए Tailscale **Serve** (tailnet) या **Funnel** (public) को स्वतः कॉन्फ़िगर कर सकता है।
Gateway dashboard and WebSocket port. This keeps the Gateway bound to loopback while
Tailscale provides HTTPS, routing, and (for Serve) identity headers.

## मोड्स

- `serve`: `tailscale serve` के माध्यम से केवल tailnet के लिए Serve। Gateway `127.0.0.1` पर ही रहता है।
- `funnel`: `tailscale funnel` के माध्यम से सार्वजनिक HTTPS। OpenClaw को एक साझा पासवर्ड की आवश्यकता होती है।
...
जब `tailscale.mode = "serve"` और `gateway.auth.allowTailscale` को `true` सेट किया गया हो,
...
- Serve/Funnel केवल **Gateway control UI + WS** को ही एक्सपोज़ करते हैं। Nodes कनेक्ट होते हैं
उसी Gateway WS endpoint के माध्यम से, इसलिए Serve node एक्सेस के लिए काम कर सकता है।
