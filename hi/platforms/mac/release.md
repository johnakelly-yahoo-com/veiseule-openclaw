...
`CHANGELOG.md` से HTML रिलीज़ नोट्स जनरेट करता है ( [`scripts/changelog-to-html.sh`](https://github.com/openclaw/openclaw/blob/main/scripts/changelog-to-html.sh) के माध्यम से ) और उन्हें appcast एंट्री में एम्बेड करता है।
...
- सैनीटी जाँच:
  ...
  - पिछले सार्वजनिक बिल्ड पर, About टैब से “Check for Updates…” चलाएँ और सुनिश्चित करें कि Sparkle नया बिल्ड बिना किसी समस्या के इंस्टॉल करता है।
