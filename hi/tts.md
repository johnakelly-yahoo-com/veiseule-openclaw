...
- डिफ़ॉल्ट रूप से, मॉडल एक ही उत्तर के लिए TTS निर्देश **उत्सर्जित कर सकता है**।
  - `inbound` केवल इनबाउंड वॉइस नोट के बाद ऑडियो भेजता है।
  - `tagged` केवल तब ऑडियो भेजता है जब उत्तर में `[[tts]]` टैग शामिल हों।
- जब `messages.tts.auto` `tagged` होता है, तो ऑडियो ट्रिगर करने के लिए ये निर्देश आवश्यक होते हैं।
