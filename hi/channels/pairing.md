...
यदि आप `device-pair` प्लगइन का उपयोग करते हैं, तो आप पहली बार डिवाइस पेयरिंग पूरी तरह से Telegram से कर सकते हैं:
...
4. सेटअप कोड पेस्ट करें और कनेक्ट करें।
5. Telegram पर वापस जाएँ: `/pair approve`

सेटअप कोड एक base64-एन्कोडेड JSON पेलोड है जिसमें शामिल है:

- `url`: Gateway WebSocket URL (`ws://...` या `wss://...`)
- `token`: एक अल्प-समय के लिए मान्य पेयरिंग टोकन
