...
3. खोज बार में (जहाँ आप सामान्यतः लोगों को जोड़ते हैं), Google Cloud Console में विन्यस्त किया गया **App name** टाइप करें।
   - **नोट**: बॉट "Marketplace" ब्राउज़ सूची में _दिखाई नहीं देगा_ क्योंकि यह एक निजी ऐप है। आपको इसे नाम से खोजकर ढूंढना होगा।
...
Google Chat वेबहुक के लिए एक सार्वजनिक HTTPS एंडपॉइंट आवश्यक है। सुरक्षा के लिए, **केवल `/googlechat` पाथ को ही** इंटरनेट पर एक्सपोज़ करें। OpenClaw डैशबोर्ड और अन्य संवेदनशील एंडपॉइंट्स को अपने निजी नेटवर्क पर ही रखें।

### विकल्प A: Tailscale Funnel (अनुशंसित)

निजी डैशबोर्ड के लिए Tailscale Serve और सार्वजनिक वेबहुक पाथ के लिए Funnel का उपयोग करें। इससे `/` निजी रहता है और केवल `/googlechat` एक्सपोज़ होता है।
...
> > नोट: यह कॉन्फ़िगरेशन रीबूट के बाद भी बना रहता है। इसे बाद में हटाने के लिए, `tailscale funnel reset` और `tailscale serve reset` चलाएँ।
