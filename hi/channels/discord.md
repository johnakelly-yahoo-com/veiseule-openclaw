...
| polls          | सक्रिय  | पोल बनाएँ                                           |
| permissions    | सक्रिय  | चैनल अनुमति स्नैपशॉट                                |
| messages       | सक्रिय  | पढ़ें/भेजें/संपादित/हटाएँ                           |
| threads        | सक्रिय  | बनाएँ/सूचीबद्ध/उत्तर दें                            |
| pins           | सक्रिय  | पिन/अनपिन/सूची                                      |
| search         | सक्रिय  | संदेश खोज (preview फीचर)         |
| memberInfo     | सक्रिय  | सदस्य जानकारी                                       |
| roleInfo       | सक्रिय  | भूमिका सूची                                         |
| channelInfo    | सक्रिय  | चैनल जानकारी + सूची                                 |
| channels       | सक्रिय  | चैनल/श्रेणी प्रबंधन                                 |
| voiceStatus    | सक्रिय  | वॉइस स्टेट लुकअप                                    |
| events         | सक्रिय  | शेड्यूल्ड इवेंट्स सूची/निर्माण                      |
