...
**User mentions के लिए अतिरिक्त अनुमति:** Conversation में मौजूद users के लिए @mentions डिफ़ॉल्ट रूप से काम करते हैं। हालांकि, यदि आप उन users को dynamically खोजकर mention करना चाहते हैं जो **वर्तमान conversation में नहीं हैं**, तो `User.Read.All` (Application) permission जोड़ें और admin consent प्रदान करें।
...
- `channels.msteams.teams.<teamId>
  .replyStyle`: प्रति-टीम ओवरराइड।.channels.<conversationId>**चैनल/ग्रुप्स:** अटैचमेंट्स M365 स्टोरेज (SharePoint/OneDrive) में रहते हैं।
