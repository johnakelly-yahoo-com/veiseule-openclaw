...
- **localhost नहीं**: Tailscale Serve का उपयोग करें (यदि `gateway.auth.allowTailscale: true` है तो बिना टोकन), टोकन के साथ tailnet bind, या एक SSH टनल। देखें [Web surfaces](/web)।
