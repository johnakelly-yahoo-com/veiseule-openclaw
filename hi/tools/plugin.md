...
1. `plugins.load.paths` (फ़ाइल या डायरेक्टरी)

- वर्कस्पेस एक्सटेंशन्स
...
`npm install --ignore-scripts` (कोई lifecycle scripts नहीं) के साथ इंस्टॉल करता है। Plugin dependency
trees को "pure JS/TS" रखें और उन packages से बचें जिनमें `postinstall` builds की आवश्यकता होती है।
...
जब आप **new chat surface** (एक "messaging channel") चाहते हों, न कि model provider, तब इसका उपयोग करें।
Model provider docs `/providers/*` के अंतर्गत उपलब्ध हैं।

1. चैनल मेटाडेटा परिभाषित करें
