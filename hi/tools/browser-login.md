...
मॉडल को अपनी क्रेडेंशियल्स **न दें**। स्वचालित लॉगिन अक्सर एंटी‑बॉट सुरक्षा को सक्रिय कर देते हैं और खाते को लॉक कर सकते हैं।

मुख्य ब्राउज़र दस्तावेज़ों पर वापस जाएँ: [Browser](/tools/browser).

## कौन‑सी Chrome प्रोफ़ाइल उपयोग होती है?

OpenClaw एक **समर्पित Chrome प्रोफ़ाइल** (नाम `openclaw`, नारंगी‑रंग वाली UI) को नियंत्रित करता है। यह आपकी दैनिक ब्राउज़र प्रोफ़ाइल से अलग है।
...
सैंडबॉक्स किए गए ब्राउज़र सत्रों में बॉट पहचान ट्रिगर होने की **अधिक संभावना** होती है। X/Twitter (और अन्य सख्त साइटों) के लिए, **होस्ट** ब्राउज़र को प्राथमिकता दें।

यदि एजेंट सैंडबॉक्स में है, तो ब्राउज़र टूल डिफ़ॉल्ट रूप से सैंडबॉक्स का उपयोग करता है। होस्ट नियंत्रण की अनुमति देने के लिए:
