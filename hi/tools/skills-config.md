...
- `allowBundled`: केवल **बंडल्ड** स्किल्स के लिए वैकल्पिक allowlist। जब सेट किया जाता है, तो सूची में मौजूद केवल बंडल्ड स्किल्स ही पात्र होती हैं (managed/workspace स्किल्स अप्रभावित रहती हैं)।
...
- `install.nodeManager`: नोड इंस्टॉलर प्राथमिकता (`npm` | `pnpm` | `yarn` | `bun`, डिफ़ॉल्ट: npm)। यह केवल **स्किल इंस्टॉल** को प्रभावित करता है; गेटवे रनटाइम अभी भी Node होना चाहिए (WhatsApp/Telegram के लिए Bun अनुशंसित नहीं है)।
...
- `entries` के अंतर्गत कीज़ डिफ़ॉल्ट रूप से स्किल नाम से मैप होती हैं। यदि कोई स्किल `metadata.openclaw.skillKey` परिभाषित करता है, तो उसी की का उपयोग करें।
- watcher सक्षम होने पर skills में किए गए परिवर्तन अगले एजेंट टर्न पर लागू हो जाते हैं।

### सैंडबॉक्स्ड स्किल्स + env vars

जब कोई सेशन **sandboxed** होता है, तो स्किल प्रोसेसेस Docker के अंदर चलते हैं। सैंडबॉक्स होस्ट `process.env` को इनहेरिट नहीं करता।
