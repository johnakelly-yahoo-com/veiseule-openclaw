...
- पूल नोट:
  - तेज़ यूनिट शार्ड्स के लिए OpenClaw Node 22/23 पर Vitest `vmForks` का उपयोग करता है।
  - Node 24+ पर, OpenClaw Node VM लिंकिंग त्रुटियों (`ERR_VM_MODULE_LINK_FAILURE` / `module is already linked`) से बचने के लिए स्वचालित रूप से नियमित `forks` पर वापस चला जाता है।
  - `OPENCLAW_TEST_VM_FORKS=0` (force `forks`) या `OPENCLAW_TEST_VM_FORKS=1` (force `vmForks`) के साथ मैन्युअल रूप से ओवरराइड करें।
