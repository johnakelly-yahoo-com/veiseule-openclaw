...
```powershell
# install.ps1 में अभी समर्पित -Verbose फ़्लैग नहीं है।
Set-PSDebug -Trace 1
...
`channels.telegram.allowFrom` **मानव प्रेषक का Telegram उपयोगकर्ता ID** (संख्यात्मक) है। 33. यह बॉट का यूज़रनेम नहीं है।

ऑनबोर्डिंग विज़ार्ड `@username` इनपुट स्वीकार करता है और उसे संख्यात्मक ID में परिवर्तित करता है, लेकिन OpenClaw प्राधिकरण केवल संख्यात्मक ID का उपयोग करता है।
...
- हाँ। Homebrew Linux (Linuxbrew) को सपोर्ट करता है। Quick setup:
...
- देखें [Models](/concepts/models) और [Slash commands](/tools/slash-commands)।
...
- यदि आप VPS पर हैं या किसी प्रॉक्सी के पीछे हैं, तो सुनिश्चित करें कि आउटबाउंड HTTPS की अनुमति है और DNS काम कर रहा है।
- यदि Gateway रिमोट है, तो सुनिश्चित करें कि आप Gateway होस्ट पर मौजूद लॉग देख रहे हैं।
- दस्तावेज़: [Telegram](/channels/telegram), [Channel troubleshooting](/channels/troubleshooting)।

त्वरित समाधान:

1. पहले पुष्टि करें कि Gateway पहुँच योग्य है और एजेंट चल सकता है:
