...
यदि आप “~$5 में OpenClaw 24/7” चाहते हैं, तो यह सबसे सरल और विश्वसनीय सेटअप है।
Hetzner की कीमतें बदलती रहती हैं; सबसे छोटा Debian/Ubuntu VPS चुनें और यदि OOMs आएँ तो स्केल अप करें।
...
सामान्य Docker फ्लो के लिए, देखें [Docker](/install/docker)।
...
इसे disposable infrastructure की तरह न मानें।
...
सारा long-lived state होस्ट पर होना चाहिए।
...
चल रहे कंटेनर के अंदर binaries इंस्टॉल करना एक जाल है।
...
आप उसी पैटर्न का उपयोग करके जितनी चाहें binaries इंस्टॉल कर सकते हैं।
...
सारा long-lived state रीस्टार्ट, rebuilds और reboots के बाद भी बना रहना चाहिए।
...
- इन्फ्रास्ट्रक्चर: [openclaw-terraform-hetzner](https://github.com/andreesg/openclaw-terraform-hetzner)
- Docker कॉन्फ़िग: [openclaw-docker-config](https://github.com/andreesg/openclaw-docker-config)

यह तरीका ऊपर दिए गए Docker सेटअप को पुनरुत्पादन योग्य डिप्लॉयमेंट, वर्ज़न-कंट्रोल्ड इन्फ्रास्ट्रक्चर और स्वचालित डिज़ास्टर रिकवरी के साथ पूरक बनाता है।
