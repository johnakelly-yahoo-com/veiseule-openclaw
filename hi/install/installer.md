...
| `--verbose`                     | डिबग आउटपुट सक्षम करें (`set -x`, npm notice-level logs)      |
| `--help`                        | उपयोग दिखाएँ (`-h`)                                          |
...
<AccordionGroup>
  ...
  <Accordion title="Windows: how to get verbose installer output">
    `install.ps1` वर्तमान में `-Verbose` स्विच प्रदान नहीं करता।
    स्क्रिप्ट-स्तरीय डायग्नोस्टिक्स के लिए PowerShell tracing का उपयोग करें:
