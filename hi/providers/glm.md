...
GLM is a **model family** (not a company) available through the Z.AI platform. OpenClaw में, GLM
मॉडल्स को `zai` provider और `zai/glm-5` जैसे मॉडल IDs के माध्यम से एक्सेस किया जाता है।
