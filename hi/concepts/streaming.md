...
**चैनल नोट:** नॉन-टेलीग्राम चैनलों के लिए, ब्लॉक स्ट्रीमिंग **डिफ़ॉल्ट रूप से बंद** रहती है जब तक `*.blockStreaming` को स्पष्ट रूप से `true` न किया जाए। Telegram बिना ब्लॉक रिप्लाई के
(`channels.telegram.streamMode`) एक लाइव प्रीव्यू स्ट्रीम कर सकता है।
