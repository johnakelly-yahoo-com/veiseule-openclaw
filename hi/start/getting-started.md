...
यदि आप OpenClaw को एक service account के रूप में चलाते हैं या कस्टम config/state स्थान चाहते हैं:

- `OPENCLAW_HOME` आंतरिक पथ समाधान के लिए उपयोग की जाने वाली होम डायरेक्टरी सेट करता है।
- `OPENCLAW_STATE_DIR` state डायरेक्टरी को ओवरराइड करता है।
- `OPENCLAW_CONFIG_PATH` config फ़ाइल पथ को ओवरराइड करता है।

पूर्ण environment variable संदर्भ: [Environment vars](/help/environment)।
