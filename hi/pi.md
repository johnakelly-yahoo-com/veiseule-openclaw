...
OpenClaw अपनी मैसेजिंग गेटवे आर्किटेक्चर में एक AI कोडिंग एजेंट को एम्बेड करने के लिए pi SDK का उपयोग करता है। pi को एक subprocess के रूप में शुरू करने या RPC मोड का उपयोग करने के बजाय, OpenClaw सीधे pi के `AgentSession` को `createAgentSession()` के माध्यम से इम्पोर्ट और इंस्टैंशिएट करता है। यह एम्बेडेड तरीका निम्नलिखित प्रदान करता है:
...
pi-agent-core का `AgentTool`, pi-coding-agent के `ToolDefinition` की तुलना में एक अलग `execute` सिग्नेचर रखता है। `pi-tool-definition-adapter.ts` में मौजूद एडेप्टर इस अंतर को पाटता है:
