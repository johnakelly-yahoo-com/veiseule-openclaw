...
### Ik zit vast, wat is de snelste manier om weer verder te gaan
...
### Ik kan geen toegang krijgen tot docs.openclaw.ai – SSL-fout. Wat nu?
...
Eenregelige commando's (macOS/Linux):
...
Documentatie: [Bijwerken](/cli/update), [Ontwikkelkanalen](/install/development-channels),
[Install](/install).
