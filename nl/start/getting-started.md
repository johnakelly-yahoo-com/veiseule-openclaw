...
Als je OpenClaw uitvoert als een serviceaccount of aangepaste configuratie-/statuslocaties wilt gebruiken:

- `OPENCLAW_HOME` stelt de homedirectory in die wordt gebruikt voor interne padresolutie.
- `OPENCLAW_STATE_DIR` overschrijft de statusmap.
- `OPENCLAW_CONFIG_PATH` overschrijft het pad naar het configuratiebestand.

Volledige referentie van omgevingsvariabelen: [Omgevingsvariabelen](/help/environment).
