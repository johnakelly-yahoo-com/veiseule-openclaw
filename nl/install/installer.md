...
| Flag                                              | Beschrijving                                                                                                                     |
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| \`--install-method npm\\                        | Kies installatiemethode (standaard: `npm`). Alias: `--method` |
| `--npm`                                           | Snelkoppeling voor npm-methode                                                                                                   |
| `--git`                                           | Snelkoppeling voor git-methode. Alias: `--github`                                                |
| \`--version <version\\ | npm-versie of dist-tag (standaard: `latest`)                                                  |
...
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| \`OPENCLAW_INSTALL_METHOD=git\\                        | Installatiemethode                                                                   |
| \`OPENCLAW_VERSION=latest\\                                                 | npm-versie of dist-tag                                                               |
| \`OPENCLAW_BETA=0\\                                                         | Beta gebruiken indien beschikbaar                                                    |
| `OPENCLAW_GIT_DIR=&lt;path&gt;`                                                                          | Checkout-directory                                                                   |
| \`OPENCLAW_GIT_UPDATE=0\\                              | Git-updates schakelen                                                                |
...
| \`OPENCLAW_NPM_LOGLEVEL=error\\                        | npm-logniveau                                                                        |
| \`SHARP_IGNORE_GLOBAL_LIBVIPS=0\\ | Gedrag van sharp/libvips bepalen (standaard: `1`) |
...
<Tabs>
  ...
  <Tab title="Debug trace">
    ```powershell
    # install.ps1 heeft nog geen aparte -Verbose-vlag.
```
    Set-PSDebug -Trace 1
...
| Flag                     | Beschrijving                                                                                 |
| ------------------------ | -------------------------------------------------------------------------------------------- |
| \`-InstallMethod npm\\ | Installatiemethode (standaard: `npm`)                     |
...
<AccordionGroup>
  ...
  <Accordion title="Windows: how to get verbose installer output">
    `install.ps1` biedt momenteel geen `-Verbose`-optie.
    Gebruik PowerShell-tracing voor scriptdiagnostiek:
