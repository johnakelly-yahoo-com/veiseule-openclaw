...
- [IRC](/channels/irc) — Serveurs IRC classiques ; canaux et messages privés avec contrôles d’appairage/liste d’autorisation.
...
- Le comportement des groupes varie selon le canal ; voir [Groups](/channels/groups).
