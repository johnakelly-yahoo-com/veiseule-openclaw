...
- **Aperçu du flux en direct :** optionnel `channels.telegram.streamMode` envoie un message temporaire et le met à jour avec `editMessageText`. Ceci est distinct du streaming de blocs de canaux.
