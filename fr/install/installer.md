...
<Note>Si l’installateur se termine mais que `openclaw` n’est pas trouvé dans un nouveau terminal, il s’agit généralement d’un problème de PATH Node/npm. Voir : [Install](/install/node#troubleshooting).</Note>
