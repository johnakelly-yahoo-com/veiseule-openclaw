...
| F2   | Gateway | Agent       | Przekierowane wiadomości               | Session isolation     |
...
| **Description**         | Atakujący skanuje w poszukiwaniu wystawionych punktów końcowych bramy OpenClaw                         |
| **Attack Vector**       | Skanowanie sieci, zapytania Shodan, enumeracja DNS                                                     |
| **Affected Components** | Brama, wystawione punkty końcowe API                                                                   |
| **Current Mitigations** | Opcja uwierzytelniania Tailscale, domyślne wiązanie z loopback                                         |
| **Residual Risk**       | Średnie - publiczne bramy możliwe do wykrycia                                                          |
...
| ----------------------- | -------------------------------------------------------------------------------------- |
| **ATLAS ID**            | AML.T0006 - Aktywne skanowanie                                         |
| **Description**         | Atakujący sonduje kanały komunikacyjne w celu identyfikacji kont zarządzanych przez AI |
| **Attack Vector**       | Wysyłanie wiadomości testowych, obserwowanie wzorców odpowiedzi                        |
...
| Zgłaszanie przez społeczność | Częściowe (`skillReports` table exists) | Medium                                                                |
...
| Identyfikator zagrożenia | Prawdopodobieństwo | Impact    | Risk Level   | Priorytet |
| ------------------------ | ------------------ | --------- | ------------ | --------- |
| T-EXEC-001               | High               | Krytyczny | **Critical** | P0        |
| T-PERSIST-001            | High               | Krytyczny | **Critical** | P0        |
| T-EXFIL-003              | Medium             | Krytyczne | **Critical** | P0        |
| T-IMPACT-001             | Medium             | Krytyczny | **High**     | P1        |
