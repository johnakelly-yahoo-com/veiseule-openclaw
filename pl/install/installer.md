...
| Flaga                                             | Opis                                                                                                                             |
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| \`--install-method npm\\                        | Wybór metody instalacji (domyślnie: `npm`). Alias: `--method` |
| `--npm`                                           | Skrót do metody npm                                                                                                              |
| `--git`                                           | Skrót do metody git. Alias: `--github`                                                           |
| \`--version <version\\ | Wersja npm lub dist-tag (domyślnie: `latest`)                                                 |
...
| Zmienna                                                                                            | Opis                                                                                  |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| \`OPENCLAW_INSTALL_METHOD=git\\                        | Metoda instalacji                                                                     |
| \`OPENCLAW_VERSION=latest\\                                                 | Wersja npm lub dist-tag                                                               |
| \`OPENCLAW_BETA=0\\                                                         | Użyj beta, jeśli dostępne                                                             |
| `OPENCLAW_GIT_DIR=&lt;path&gt;`                                                                          | Katalog checkoutu                                                                     |
| \`OPENCLAW_GIT_UPDATE=0\\                              | Przełącznik aktualizacji git                                                          |
...
| \`OPENCLAW_NPM_LOGLEVEL=error\\                        | Poziom logów npm                                                                      |
| \`SHARP_IGNORE_GLOBAL_LIBVIPS=0\\ | Kontrola zachowania sharp/libvips (domyślnie: `1`) |
...
| Flaga                    | Opis                                                                                        |
| ------------------------ | ------------------------------------------------------------------------------------------- |
| \`-InstallMethod npm\\ | Metoda instalacji (domyślnie: `npm`)                     |
