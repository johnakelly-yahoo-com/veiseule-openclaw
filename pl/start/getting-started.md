...
Jeśli uruchamiasz OpenClaw jako konto usługi lub chcesz używać niestandardowych lokalizacji konfiguracji/stanu:

- `OPENCLAW_HOME` ustawia katalog domowy używany do wewnętrznego rozwiązywania ścieżek.
- `OPENCLAW_STATE_DIR` nadpisuje katalog stanu.
- `OPENCLAW_CONFIG_PATH` nadpisuje ścieżkę do pliku konfiguracyjnego.

Pełna lista zmiennych środowiskowych: [Environment vars](/help/environment).
