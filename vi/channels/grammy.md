...
- **Xem trước phát trực tiếp:** tùy chọn `channels.telegram.streamMode` gửi một tin nhắn tạm thời và cập nhật bằng `editMessageText`. This is separate from channel block streaming.
