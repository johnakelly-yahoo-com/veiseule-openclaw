...
Thông số npm chỉ ở dạng **registry-only** (tên package + phiên bản/tag tùy chọn). Các thông số Git/URL/file
spec sẽ bị từ chối. Cài đặt dependency chạy với `--ignore-scripts` để đảm bảo an toàn.
