...
<Note>
Nếu bạn thiết lập lần đầu, hãy bắt đầu với [Getting Started](/start/getting-started).
...
- **Cấu hình:** `~/.openclaw/openclaw.json` (JSON/JSON5 tương tự)
...
- **Danh sách cho phép ghép nối**: `~/.openclaw/credentials/<channel>-allowFrom.json`
