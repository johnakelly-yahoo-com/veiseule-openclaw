...
1. **Model/Auth** — API key Anthropic (khuyến nghị), OpenAI, hoặc Custom Provider
   (tương thích OpenAI, tương thích Anthropic hoặc Unknown tự động phát hiện). 45. Chọn một model mặc định.
