...
Xem mọi người đang xây dựng gì với OpenClaw. Hỏi “Robby” (@openclaw) về một kỹ năng hầm rượu vang tại nhà.
...
Nó yêu cầu một bản xuất CSV mẫu + nơi lưu trữ, sau đó xây dựng/kiểm thử kỹ năng rất nhanh (962 chai trong ví dụ). Tự động hóa việc đặt bữa ăn học đường tại Vương quốc Anh qua ParentPay.
...
Sử dụng tọa độ chuột để nhấp ô bảng một cách đáng tin cậy. Tải lên Cloudflare R2/S3 và tạo các liên kết tải xuống được ký trước an toàn. </Card>

<Card title="R2 Upload (Send Me My Files)" icon="cloud-arrow-up" href="https://clawhub.com/skills/r2-upload">
  **@julianengel** • `files` `r2` `presigned-urls`

Hoàn hảo cho các phiên bản OpenClaw chạy từ xa. Bài viết [phân tích kỹ thuật toàn diện](https://github.com/adam91holt/orchestrated-ai-articles) bao quát danh sách Dream Team, lựa chọn mô hình, sandboxing, webhook, heartbeat và các luồng ủy quyền. </Card>
...
14+ agents under one gateway with Opus 4.5 orchestrator delegating to Codex workers. [Bài blog](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/). [Clawdspace](https://github.com/adam91holt/clawdspace) for agent sandboxing. CLI cho Linear tích hợp với các quy trình agentic (Claude Code, OpenClaw). </Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`

31. CLI cho Linear tích hợp với các quy trình agentic (Claude Code, OpenClaw). Đọc, gửi và lưu trữ tin nhắn qua Beeper Desktop. First external PR merged!</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli` `automation`

Sử dụng API MCP cục bộ của Beeper để agent có thể quản lý tất cả các cuộc chat của bạn (iMessage, WhatsApp, v.v.). Uses Beeper local MCP API so agents can manage all your chats (iMessage, WhatsApp, etc.) in one place. </Card>
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a OpenClaw persona. </Card>
...
Thu thập PDF từ email, chuẩn bị tài liệu cho tư vấn thuế. Monthly accounting on autopilot. </Card>

<Card title="Couch Potato Dev Mode" icon="couch" href="https://davekiss.com">
  **@davekiss** • `telegram` `website` `migration` `astro`

Rebuilt entire personal site via Telegram while watching Netflix — Notion → Astro, 18 posts migrated, DNS to Cloudflare. Never opened a laptop. </Card>

<Card title="Job Search Agent" icon="briefcase">
  **@attol8** • `automation` `api` `skill`

Searches job listings, matches against CV keywords, and returns relevant opportunities with links. Xây dựng trong 30 phút bằng JSearch API. </Card>

<Card title="Jira Skill Builder" icon="diagram-project" href="https://x.com/jdrhyne/status/2008336434827002232">
  **@jdrhyne** • `automation` `jira` `skill` `devtools`

OpenClaw connected to Jira, then generated a new skill on the fly (before it existed on ClawHub). </Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Tự động hóa tác vụ Todoist và để OpenClaw tạo skill trực tiếp trong chat Telegram. </Card>

<Card title="TradingView Analysis" icon="chart-line">
  **@bheem1798** • `finance` `browser` `automation`

Logs into TradingView via browser automation, screenshots charts, and performs technical analysis on demand. No API needed—just browser control. </Card>

<Card title="Slack Auto-Support" icon="slack">
  **@henrymascot** • `slack` `automation` `support`

Theo dõi kênh Slack của công ty, phản hồi hữu ích và chuyển tiếp thông báo sang Telegram. Autonomously fixed a production bug in a deployed app without being asked. </Card>
...
Thêm tìm kiếm vector cho bookmark Karakeep bằng Qdrant + embedding OpenAI/Ollama. </Card>
...
Phiên âm âm thanh đa ngôn ngữ qua OpenRouter (Gemini, v.v.). Available on ClawHub. </Card>
...
Skill lịch sử dụng khal/vdirsyncer. Self-hosted calendar integration. </Card>
