...
Sử dụng tọa độ chuột để nhấp ô bảng một cách đáng tin cậy. Tải lên Cloudflare R2/S3 và tạo các liên kết tải xuống được ký trước an toàn. 
</Card>

<Card title="R2 Upload (Send Me My Files)" icon="cloud-arrow-up" href="https://clawhub.com/skills/r2-upload">
  **@julianengel** • `files` `r2` `presigned-urls`

Hoàn hảo cho các phiên bản OpenClaw chạy từ xa. Bài viết [phân tích kỹ thuật toàn diện](https://github.com/adam91holt/orchestrated-ai-articles) bao quát danh sách Dream Team, lựa chọn mô hình, sandboxing, webhook, heartbeat và các luồng ủy quyền. 
</Card>
...
14+ agents under one gateway with Opus 4.5 orchestrator delegating to Codex workers. [Bài blog](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/). [Clawdspace](https://github.com/adam91holt/clawdspace) for agent sandboxing. CLI cho Linear tích hợp với các quy trình agentic (Claude Code, OpenClaw). 
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`

31. CLI cho Linear tích hợp với các quy trình agentic (Claude Code, OpenClaw). Đọc, gửi và lưu trữ tin nhắn qua Beeper Desktop. First external PR merged!
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli` `automation`

Sử dụng API MCP cục bộ của Beeper để agent có thể quản lý tất cả các cuộc chat của bạn (iMessage, WhatsApp, v.v.). Uses Beeper local MCP API so agents can manage all your chats (iMessage, WhatsApp, etc.) in one place. 
</Card>
...
Thu thập PDF từ email, chuẩn bị tài liệu cho tư vấn thuế. Monthly accounting on autopilot. 
</Card>
...
Searches job listings, matches against CV keywords, and returns relevant opportunities with links. Xây dựng trong 30 phút bằng JSearch API. 
</Card>
...
Theo dõi kênh Slack của công ty, phản hồi hữu ích và chuyển tiếp thông báo sang Telegram. Autonomously fixed a production bug in a deployed app without being asked. 
</Card>
...
Phiên âm âm thanh đa ngôn ngữ qua OpenRouter (Gemini, v.v.). Available on ClawHub. 
</Card>
...
Skill lịch sử dụng khal/vdirsyncer. Self-hosted calendar integration. 
</Card>
