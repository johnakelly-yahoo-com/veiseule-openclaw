...
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| **Riêng tư**    | 33. Hoàn toàn riêng tư. 34. Prompt/phản hồi **không bao giờ được lưu trữ hoặc ghi log**. Tạm thời. | Llama, Qwen, DeepSeek, Venice Uncensored, v.v. |
| **Ẩn danh** | Được chuyển tiếp qua Venice với metadata đã được loại bỏ. Nhà cung cấp nền tảng (OpenAI, Anthropic) chỉ thấy các yêu cầu đã được ẩn danh.                   | Claude, GPT, Gemini, Grok, Kimi, MiniMax                                       |
...
Sau khi thiết lập, OpenClaw hiển thị tất cả các mô hình Venice hiện có. Hãy chọn dựa trên nhu cầu của bạn:
