...
Các kênh có thể gửi lại cùng một thông điệp sau khi kết nối lại. OpenClaw duy trì một
...
- `Body`: văn bản lời nhắc được gửi đến agent. Nội dung này có thể bao gồm các lớp bao của kênh và
các lớp bao lịch sử tùy chọn.
...
Block streaming gửi các phản hồi từng phần khi mô hình tạo ra các khối văn bản.
