...
Các ví dụ dưới đây được căn chỉnh theo schema cấu hình hiện tại. Để xem tài liệu tham khảo đầy đủ và ghi chú cho từng trường, hãy xem [Configuration](/gateway/configuration).
