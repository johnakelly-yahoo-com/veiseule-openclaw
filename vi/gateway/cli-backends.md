...
OpenClaw có thể chạy **local AI CLIs** như một **phương án dự phòng chỉ văn bản** khi các nhà cung cấp API gặp sự cố,
...
vẫn có thể chạy bộ công cụ agent riêng của họ.
