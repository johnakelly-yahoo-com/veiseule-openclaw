...
- **Trực tiếp (ws/wss)**: Kết nối thẳng tới URL của gateway. Gateway nhìn thấy địa chỉ IP thực của client.
...
- Máy chủ từ xa cần các quyền TCC giống như máy cục bộ (Automation, Accessibility, Screen Recording, Microphone, Speech Recognition, Notifications). Hãy chạy quy trình onboarding trên máy đó để cấp quyền một lần.
