...
**Añade a la configuración de tu shell (zsh):**
...
Consulta el [`ClawDock` Helper README](https://github.com/openclaw/openclaw/blob/main/scripts/shell-helpers/README.md) para más detalles.
