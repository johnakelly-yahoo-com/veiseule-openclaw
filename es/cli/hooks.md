...
Inyecta archivos adicionales de bootstrap (por ejemplo `AGENTS.md` / `TOOLS.md` locales de un monorepo) durante `agent:bootstrap`.

**Habilitar:**

```bash
Los hooks de openclaw habilitan bootstrap-extra-files
```
