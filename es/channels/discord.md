...
| channelInfo       | habilitado        | Información + listado de canales                             |
| channels          | habilitado        | Gestión de canales/categorías                                |
| voiceStatus       | habilitado        | Consulta de estado de voz                                    |
| events            | habilitado        | Listar/crear eventos programados                             |
| roles             | deshabilitado       | Agregar/quitar roles                                         |
| moderación        | deshabilitado       | Timeout/expulsar/prohibir                                    |
| presencia          | deshabilitado       | Estado/actividad del bot (setPresence)    |
