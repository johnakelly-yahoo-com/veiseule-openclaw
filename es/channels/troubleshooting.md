...
| Actualizaste y la allowlist te bloquea           | `openclaw security audit` y allowlists de configuración               | Ejecuta `openclaw doctor --fix` o reemplaza `@username` por IDs numéricos de remitente. |
