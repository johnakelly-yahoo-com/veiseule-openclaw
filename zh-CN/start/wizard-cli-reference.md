...
<AccordionGroup>
  ...
  <Accordion title="Custom provider">适用于 OpenAI-compatible 和 Anthropic-compatible 端点。
...
<Note>
Some channels are delivered as plugins. 在入门流程中选择后，向导会在配置频道之前提示安装插件（npm 或本地路径）。
</Note>
