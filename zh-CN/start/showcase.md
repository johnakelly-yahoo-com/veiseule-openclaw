...
Real projects from the community. 来自社区的真实项目。看看大家正在用 OpenClaw 构建什么。
...
每周餐饮计划 → 常购商品 → 预订配送时段 → 确认订单。无需 API，仅使用浏览器控制。 No APIs, just browser control.
...
</Card> Uses mouse coordinates for reliable table cell clicking. 
</Card>
...
</Card> Perfect for remote OpenClaw instances. 
</Card>
...
45. 在一个网关下运行 14+ 个代理，由 Opus 4.5 编排器将任务委派给 Codex 工作节点。 Comprehensive [technical write-up](https://github.com/adam91holt/orchestrated-ai-articles) covering the Dream Team roster, model selection, sandboxing, webhooks, heartbeats, and delegation flows. 46. 用于代理沙箱的 [Clawdspace](https://github.com/adam91holt/clawdspace)。 [Blog post](https://adams-ai-journey.ghost.io/2026-the-year-of-the-orchestrator/).
</Card>
...
</Card> Manage issues, projects, and workflows from the terminal. First external PR merged! 
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli` `automation`

Read, send, and archive messages via Beeper Desktop. 通过 Beeper Desktop 读取、发送和归档消息。使用 Beeper 本地 MCP API，让智能体可以在一个地方管理你的所有聊天（iMessage、WhatsApp 等）。 
</Card> in one place. 
</Card>
...
Playtomic 可用性检查器 + 预订 CLI。再也不会错过空闲场地。 Never miss an open court again.
...
</Card> Built in 30 minutes using JSearch API. 
</Card>
...
</Card> No API needed—just browser control. 
</Card>

<Card title="Slack Auto-Support" icon="slack">
  **@henrymascot** • `slack` `automation` `support`

Watches company Slack channel, responds helpfully, and forwards notifications to Telegram. 1. 在未被要求的情况下，自主修复了已部署应用中的一个生产环境 bug。
2. 
</Card>
...
32. 开箱即用、nix 化的 OpenClaw 配置，用于可复现的部署。
33. 
</Card>
...
45. 完整的天文设备市场。 46. 基于或围绕 OpenClaw 生态系统构建。
46. 
</Card>
