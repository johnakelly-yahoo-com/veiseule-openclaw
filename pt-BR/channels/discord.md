...
| channelInfo    | ativado  | Info do canal + lista                                    |
| channels       | ativado  | Gerenciamento de canais/categorias                       |
| voiceStatus    | ativado  | Consulta de estado de voz                                |
| events         | ativado  | Listar/criar eventos agendados                           |
| funções          | desativado | Adicionar/remover cargos                                 |
| moderação     | desativado | Timeout/expulsar/banir                                   |
| presença       | desativado | Status/atividade do bot (setPresence) |
