...
ตั้งค่า `agents.defaults.userTimezone` เพื่อบอกโมเดลถึงเขตเวลาท้องถิ่นของผู้ใช้
เรายังแนบฟิลด์ที่ทำให้เป็นมาตรฐานเพื่อความสอดคล้อง: TypeBox เป็นไลบรารีสคีมาที่ยึด TypeScript เป็นหลัก ตั้งค่า `agents.defaults.userTimezone` เพื่อบอกโมเดลถึงเขตเวลาท้องถิ่นของผู้ใช้ หากไม่ได้ตั้งค่า
