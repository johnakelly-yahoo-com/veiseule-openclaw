...
17. workspace คือบ้านของเอเจนต์ workspace คือบ้านของเอเจนต์ เวิร์กสเปซคือบ้านของเอเจนต์ เป็นไดเรกทอรีทำงานเพียงแห่งเดียวที่ใช้กับเครื่องมือจัดการไฟล์และบริบทของเวิร์กสเปซ ควรเก็บไว้เป็นส่วนตัวและปฏิบัติกับมันเหมือนหน่วยความจำ 18. เก็บไว้เป็นส่วนตัวและปฏิบัติต่อมันเหมือนหน่วยความจำ
...
22. การติดตั้งรุ่นเก่าอาจสร้าง `~/openclaw` ไว้แล้ว การติดตั้งรุ่นเก่าอาจสร้าง `~/openclaw` ไว้แล้ว การติดตั้งรุ่นเก่าอาจเคยสร้าง `~/openclaw` การเก็บไดเรกทอรีเวิร์กสเปซหลายแห่งพร้อมกันอาจทำให้เกิดความสับสนด้านการยืนยันตัวตนหรือสถานะไม่ตรงกัน เนื่องจากจะมีเวิร์กสเปซที่ทำงานอยู่ได้เพียงแห่งเดียวในแต่ละครั้ง

**คำแนะนำ:** ควรมี workspace ที่ใช้งานอยู่เพียงหนึ่งเดียว 24. 24. หากคุณไม่ใช้
...
`openclaw setup` สามารถสร้างค่าเริ่มต้นที่ขาดหายไปใหม่ได้โดยไม่เขียนทับไฟล์ที่มีอยู่
`openclaw setup` สามารถสร้างค่าเริ่มต้นที่หายไปใหม่ได้โดยไม่เขียนทับไฟล์ที่มีอยู่
