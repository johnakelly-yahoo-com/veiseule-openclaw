...
- การ override ระดับช่องทาง (`channels.whatsapp.*`, `channels.telegram.*` ฯลฯ) สำหรับขีดจำกัดและสวิตช์การสตรีม for caps and streaming toggles. for caps and streaming toggles.
...
และใช้ข้อความล่าสุดสำหรับการผูกเธรดการตอบกลับ/ID ข้อความที่ส่งมาต่อเนื่องอย่างรวดเร็วจาก **ผู้ส่งเดียวกัน** สามารถถูกรวมเป็นหนึ่งเทิร์นของเอเจนต์ได้ผ่าน `messages.inbound` การทำ debouncing จะกำหนดขอบเขตต่อช่องทาง + บทสนทนา
...
อุปกรณ์/ช่องทางหลายรายการสามารถแมปไปยังเซสชันเดียวกันได้ แต่ประวัติจะไม่ถูกแชร์อย่างสมบูรณ์
...
messages consistent in the agent prompt. This keeps real-time and queued/history
