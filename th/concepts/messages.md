...
## การหน่วงเวลาเพื่อลดความถี่ข้อความขาเข้า
...
- `Body`: ข้อความพรอมป์ต์ที่ส่งไปยังเอเจนต์ ซึ่งอาจรวมถึงซองข้อมูลของช่องทางและ
ตัวห่อหุ้มประวัติเสริม (ถ้ามี)
