...
CLI มักเชื่อมต่อเพื่อคำสั่งสั้น ๆ แบบครั้งเดียว CLI มักเชื่อมต่อสั้นๆเพื่อรันคำสั่งแบบครั้งเดียว เพื่อหลีกเลี่ยงการรบกวนรายการ
Instances จึง **ไม่** นำ `client.mode === "cli"` มาสร้างเป็นรายการ presence CLI มักเชื่อมต่อสั้นๆเพื่อรันคำสั่งแบบครั้งเดียว เพื่อหลีกเลี่ยงการรบกวนรายการ
