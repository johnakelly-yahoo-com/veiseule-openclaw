...
แฟล็กการวินิจฉัยช่วยให้คุณเปิดใช้ดีบักล็อกแบบเจาะจงได้โดยไม่ต้องเปิดการบันทึกล็อกแบบละเอียดทุกที่ แฟล็กเป็นแบบเลือกเปิด(opt-in)และจะไม่มีผลใดๆเว้นแต่ซับซิสเต็มจะตรวจสอบแฟล็กเหล่านั้น แฟล็กการวินิจฉัยช่วยให้คุณเปิดใช้ดีบักล็อกแบบเจาะจงได้โดยไม่ต้องเปิดการบันทึกล็อกแบบละเอียดทุกที่ แฟล็กเป็นแบบเลือกเปิด(opt-in)และจะไม่มีผลใดๆเว้นแต่ซับซิสเต็มจะตรวจสอบแฟล็กเหล่านั้น Flags are opt-in and have no effect unless a subsystem checks them.
...
แฟล็กจะปล่อยล็อกไปยังไฟล์ล็อกการวินิจฉัยมาตรฐาน โดยค่าเริ่มต้น: By default: By default:
...
- หากตั้งค่า `logging.level` สูงกว่า `warn` ล็อกเหล่านี้อาจถูกระงับ ค่าเริ่มต้น `info` ใช้งานได้ Default `info` is fine. Default `info` is fine.
