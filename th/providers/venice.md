...
| โหมด           | คำอธิบาย                                                                                                                                                         | โมเดล                                        |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| **ส่วนตัว**    | ครอบคลุมการใช้งานทั่วไป เป็นส่วนตัวเต็มรูปแบบ เป็นส่วนตัวเต็มรูปแบบ พรอมป์ต์/คำตอบ **จะไม่ถูกจัดเก็บหรือบันทึกล็อก** เป็นแบบชั่วคราว ชั่วคราว                    | Llama, Qwen, DeepSeek, Venice Uncensored ฯลฯ |
