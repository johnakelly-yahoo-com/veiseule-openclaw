...
แอปmacOS ฝัง **แผงCanvas** ที่ควบคุมโดยเอเจนต์โดยใช้ `WKWebView` โดยเป็นเวิร์กสเปซแบบภาพน้ำหนักเบาสำหรับ HTML/CSS/JS, A2UI และพื้นผิว UI แบบโต้ตอบขนาดเล็ก แอปmacOS ฝัง **แผงCanvas** ที่ควบคุมโดยเอเจนต์โดยใช้ `WKWebView` โดยเป็นเวิร์กสเปซแบบภาพน้ำหนักเบาสำหรับ HTML/CSS/JS, A2UI และพื้นผิว UI แบบโต้ตอบขนาดเล็ก มันเป็นพื้นที่ทำงานเชิงภาพน้ำหนักเบาสำหรับ HTML/CSS/JS, A2UI และพื้นผิว UI แบบโต้ตอบขนาดเล็ก
