...
Gatewayเป็นโปรเซสลูก แอปจะพยายามเชื่อมต่อกับGatewayที่กำลังรันอยู่แล้วบนพอร์ตที่กำหนดก่อน หากไม่พบจึงจะเปิดใช้งานบริการlaunchdผ่านCLIภายนอก `openclaw` (ไม่มีรันไทม์ฝังมา) วิธีนี้ช่วยให้เริ่มอัตโนมัติเมื่อเข้าสู่ระบบและรีสตาร์ตเมื่อเกิดการแครชได้อย่างเชื่อถือได้ มันจะพยายามเชื่อมต่อกับ Gateway ที่กำลังทำงานอยู่แล้วบนพอร์ตที่กำหนดค่าไว้ก่อน หากไม่สามารถเข้าถึงได้ ระบบจะเปิดใช้งานบริการ launchd ผ่าน CLI ภายนอก `openclaw` (ไม่มีรันไทม์ฝังในตัว) 1. มันจะพยายามเชื่อมต่อกับ Gateway ที่กำลังทำงานอยู่แล้วบนพอร์ตที่กำหนดค่าไว้ก่อน หากไม่สามารถเข้าถึงได้ ระบบจะเปิดใช้งานบริการ launchd ผ่าน CLI ภายนอก `openclaw` (ไม่มีรันไทม์ฝังในตัว) สิ่งนี้ช่วยให้คุณเริ่มอัตโนมัติเมื่อเข้าสู่ระบบได้อย่างเชื่อถือได้ และรีสตาร์ตใหม่เมื่อเกิดการแครช
...
2.
หากคุณต้องการการเชื่อมต่อกับ UI ที่แน่นแฟ้นกว่า ให้รัน Gateway ด้วยตนเองในเทอร์มินัล
...
8. โหมด Remote จะไม่เริ่ม Gateway ภายในเครื่อง โหมด Remote จะไม่เริ่ม Gateway ภายในเครื่อง โหมดRemoteจะไม่สตาร์ตGatewayในเครื่อง แอปจะใช้อุโมงค์SSHไปยังโฮสต์ระยะไกลและเชื่อมต่อผ่านอุโมงค์นั้น
