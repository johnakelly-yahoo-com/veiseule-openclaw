...
เมื่อเปิดใช้งาน OpenClaw จะเริ่มเซิร์ฟเวอร์ UNIX socket ภายในเครื่อง เมื่อเปิดใช้งาน OpenClaw จะเริ่มเซิร์ฟเวอร์ซ็อกเก็ต UNIX แบบโลคัล หากปิดใช้งาน โฮสต์จะถูกหยุดและ `peekaboo` จะถอยกลับไปใช้โฮสต์อื่นที่มีอยู่ เมื่อเปิดใช้งาน OpenClaw จะเริ่มเซิร์ฟเวอร์ซ็อกเก็ต UNIX แบบโลคัล หากปิดใช้งาน โฮสต์จะถูกหยุดและ `peekaboo` จะถอยกลับไปใช้โฮสต์อื่นที่มีอยู่
...
27.
หากต้องการเก็บข้อมูลนานขึ้น ให้จับใหม่จากฝั่งไคลเอนต์
