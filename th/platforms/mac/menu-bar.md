...
read_when:
  - ปรับแต่ง UI แถบเมนูของ mac หรือปรับตรรกะสถานะ
title: "แถบเมนู"
---
...
- ลำดับความสำคัญ: main ชนะเสมอ 21. 21. หาก main ทำงานอยู่ สถานะของมันจะแสดงทันที ลำดับความสำคัญ: เซสชันหลักชนะเสมอ หากเซสชันหลักกำลังทำงาน จะแสดงสถานะทันที หากเซสชันหลักว่าง จะแสดงเซสชันที่ไม่ใช่หลักซึ่งทำงานล่าสุด เราจะไม่สลับไปมาระหว่างกิจกรรม; จะสลับเฉพาะเมื่อเซสชันปัจจุบันว่างหรือเซสชันหลักเริ่มทำงาน เราจะไม่สลับไปมาระหว่างกิจกรรม; เราจะสลับเฉพาะเมื่อเซสชันปัจจุบันว่างหรือ main เริ่มทำงาน
- ประเภทกิจกรรม:
