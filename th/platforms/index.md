...
มีแอปคู่หูสำหรับ macOS (แอปบนแถบเมนู) และโหนดมือถือ (iOS/Android) มีแอปคู่หูสำหรับ macOS (แอปบนแถบเมนู) และโหนดมือถือ (iOS/Android) แอปคู่หูสำหรับ Windows และ
...
- ศูนย์กลาง VPS: [โฮสติ้ง VPS](/vps)
- Fly.io: [Fly.io](/install/fly)
- Hetzner (Docker): [Hetzner](/install/hetzner)
- GCP (Compute Engine): [GCP](/install/gcp)
- exe.dev (VM + HTTPS พร็อกซี): [exe.dev](/install/exe-dev)
