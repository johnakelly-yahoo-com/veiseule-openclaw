...
OpenProse ลงทะเบียน `/prose` เป็นคำสั่งสกิลที่ผู้ใช้เรียกใช้ได้ OpenProse ลงทะเบียน `/prose` เป็นคำสั่ง Skills ที่ผู้ใช้เรียกได้ โดยจะส่งต่อไปยังคำสั่งของ OpenProse VM และใช้เครื่องมือของ OpenClaw เบื้องหลัง OpenProse ลงทะเบียน `/prose` เป็นคำสั่ง Skills ที่ผู้ใช้เรียกได้ โดยจะส่งต่อไปยังคำสั่งของ OpenProse VM และใช้เครื่องมือของ OpenClaw เบื้องหลัง
...
ปฏิบัติต่อไฟล์ `.prose` เหมือนโค้ด 31. 31. ตรวจสอบก่อนรัน ตรวจสอบก่อนรัน ปฏิบัติต่อไฟล์ `.prose` เสมือนโค้ด ตรวจทานก่อนรัน ใช้ allowlist ของเครื่องมือ OpenClaw และเกตการอนุมัติเพื่อควบคุมผลข้างเคียง
