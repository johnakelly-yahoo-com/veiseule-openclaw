...
OpenClaw ต้องการ **Node 22 หรือใหม่กว่า** OpenClaw ต้องการ **Node 22 หรือใหม่กว่า** OpenClaw ต้องใช้ **Node 22 หรือใหม่กว่า** [สคริปต์ตัวติดตั้ง](/install#install-methods) จะตรวจจับและติดตั้ง Node ให้อัตโนมัติ — หน้านี้มีไว้สำหรับกรณีที่คุณต้องการตั้งค่า Node ด้วยตนเองและตรวจสอบให้แน่ใจว่าทุกอย่างเชื่อมต่อถูกต้อง (เวอร์ชัน, PATH, การติดตั้งแบบ global)
...
ถ้าคำสั่งนี้แสดง `v22.x.x` หรือสูงกว่า ก็ใช้งานได้ ถ้าคำสั่งนี้แสดง `v22.x.x` หรือสูงกว่า ก็ใช้งานได้ หากแสดง `v22.x.x` หรือสูงกว่า แสดงว่าใช้งานได้ หากยังไม่ได้ติดตั้ง Node หรือเวอร์ชันเก่าเกินไป ให้เลือกวิธีการติดตั้งด้านล่าง
...
<Accordion title="Using a version manager (nvm, fnm, mise, asdf)">
  ตัวจัดการเวอร์ชันช่วยให้คุณสลับเวอร์ชัน Node ได้อย่างง่ายดาย ตัวเลือกยอดนิยมได้แก่: ตัวเลือกยอดนิยม: ตัวเลือกยอดนิยม:
