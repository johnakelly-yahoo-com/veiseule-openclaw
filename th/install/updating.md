...
OpenClaw พัฒนาอย่างรวดเร็ว (ก่อน “1.0”) OpenClaw พัฒนาอย่างรวดเร็ว (ก่อน “1.0”) OpenClaw พัฒนาอย่างรวดเร็ว(ก่อนเวอร์ชัน“1.0”)ให้ปฏิบัติกับการอัปเดตเหมือนการส่งโครงสร้างพื้นฐาน: อัปเดต→รันการตรวจสอบ→รีสตาร์ต(หรือใช้ `openclaw update` ซึ่งจะรีสตาร์ตให้)→ยืนยันผลลัพธ์

## แนะนำ: รันตัวติดตั้งจากเว็บไซต์อีกครั้ง(อัปเกรดทับของเดิม)

เส้นทางการอัปเดตที่ **แนะนำ** คือการรันตัวติดตั้งจากเว็บไซต์อีกครั้ง ตัวติดตั้งจะตรวจพบการติดตั้งที่มีอยู่ อัปเกรดทับของเดิม และรัน `openclaw doctor` เมื่อจำเป็น เส้นทางการอัปเดตที่ **แนะนำ** คือการรันตัวติดตั้งจากเว็บไซต์อีกครั้ง ตัวติดตั้งจะตรวจพบการติดตั้งที่มีอยู่ อัปเกรดทับของเดิม และรัน `openclaw doctor` เมื่อจำเป็น มัน
...
หากคุณติดตั้งผ่าน **npm/pnpm** (ไม่มีเมตาดาทา git) `openclaw update` จะพยายามอัปเดตผ่านตัวจัดการแพ็กเกจของคุณ หากตรวจไม่พบการติดตั้ง ให้ใช้ “อัปเดต(ติดตั้งแบบ global)” แทน หากตรวจจับการติดตั้งไม่ได้ ให้ใช้ “Update (global install)” แทน หากตรวจจับการติดตั้งไม่ได้ ให้ใช้ “Update (global install)” แทน

## อัปเดต(Control UI / RPC)

Control UI มีปุ่ม **Update & Restart** (RPC: `update.run`) ซึ่งจะ: มัน: มัน:
