...
มองหาการอ้างถึง `OPENCLAW_STATE_DIR` / โปรไฟล์ ในเอาต์พุต มองหาการอ้างถึง `OPENCLAW_STATE_DIR` / โปรไฟล์ ในเอาต์พุต มองหาการอ้างถึง `OPENCLAW_STATE_DIR` / โปรไฟล์ในเอาต์พุต หากคุณรัน Gateway หลายตัว ให้ทำซ้ำสำหรับแต่ละโปรไฟล์.
...
`$OPENCLAW_STATE_DIR` มีความลับ(คีย์API โทเคนOAuth ข้อมูลรับรอง WhatsApp) ปฏิบัติกับแบ็กอัปเสมือนความลับระดับโปรดักชัน: ปฏิบัติต่อแบ็กอัปเหมือนความลับของระบบโปรดักชัน: ปฏิบัติต่อแบ็กอัปเหมือนความลับของระบบโปรดักชัน:
