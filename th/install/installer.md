...
| แฟล็ก                                             | คำอธิบาย                                                                                                                           |
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| \`--install-method npm\\                        | เลือกวิธีติดตั้ง (ค่าเริ่มต้น: `npm`). นามแฝง: `--method`       |
| `--npm`                                           | ทางลัดสำหรับวิธี npm                                                                                                               |
| `--git`                                           | ทางลัดสำหรับวิธี git นามแฝง: `--github` นามแฝง: `--github` นามแฝง: `--github`      |
| \`--version <version\\ | เวอร์ชัน npm หรือ dist-tag (ค่าเริ่มต้น: `latest`)                                              |
...
| ตัวแปร                                                                                             | คำอธิบาย                                                                           |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| \`OPENCLAW_INSTALL_METHOD=git\\                        | วิธีติดตั้ง                                                                        |
| \`OPENCLAW_VERSION=latest\\                                                 | เวอร์ชัน npm หรือ dist-tag                                                         |
| \`OPENCLAW_BETA=0\\                                                         | ใช้ beta หากมี                                                                     |
| `OPENCLAW_GIT_DIR=&lt;path&gt;`                                                                          | ไดเรกทอรีเช็คเอาต์                                                                 |
| \`OPENCLAW_GIT_UPDATE=0\\                              | เปิด/ปิดการอัปเดต git                                                              |
...
| \`OPENCLAW_NPM_LOGLEVEL=error\\                        | ระดับล็อก npm                                                                      |
| \`SHARP_IGNORE_GLOBAL_LIBVIPS=0\\ | ควบคุมพฤติกรรม sharp/libvips (ค่าเริ่มต้น: `1`) |
...
| แฟล็ก                    | คำอธิบาย                                                                                       |
| ------------------------ | ---------------------------------------------------------------------------------------------- |
| \`-InstallMethod npm\\ | วิธีติดตั้ง (ค่าเริ่มต้น: `npm`)                            |
...
<AccordionGroup>
  ...
  <Accordion title="Windows: how to get verbose installer output">
    ขณะนี้ `install.ps1` ยังไม่ได้เปิดให้ใช้สวิตช์ `-Verbose`
    ใช้การทำ tracing ของ PowerShell เพื่อวินิจฉัยในระดับสคริปต์:
