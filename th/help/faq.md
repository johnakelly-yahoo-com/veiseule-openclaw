...
- [Skills และออโตเมชัน](#skills-and-automation)
  ...
  - [บอทค้างขณะทำงานหนัก ๆ ฉันจะย้ายงานนั้นไปประมวลผลที่อื่นได้อย่างไร?](#the-bot-freezes-while-doing-heavy-work-how-do-i-offload-that)
...
- [Sandboxing และหน่วยความจำ](#sandboxing-and-memory)
  ...
  - [หน่วยความจำลืมสิ่งต่าง ๆ อยู่เรื่อย ๆ จะทำให้มันจำได้ถาวรได้อย่างไร?](#memory-keeps-forgetting-things-how-do-i-make-it-stick)
  - [หน่วยความจำจะถูกเก็บไว้ตลอดไปหรือไม่? มีข้อจำกัดอะไรบ้าง?](#does-memory-persist-forever-what-are-the-limits)
...
- [พื้นฐานคอนฟิก](#config-basics)
  - [ไฟล์ config ใช้รูปแบบอะไร? อยู่ที่ไหน?](#what-format-is-the-config-where-is-it)
  ...
  - [`config.apply` ลบ config ของฉันหมด ฉันจะกู้คืนและป้องกันไม่ให้เกิดขึ้นอีกได้อย่างไร?](#configapply-wiped-my-config-how-do-i-recover-and-avoid-this)
...
- [Env vars และการโหลด .env](#env-vars-and-env-loading)
  ...
  - [ฉันตั้งค่า `COPILOT_GITHUB_TOKEN` แล้ว แต่สถานะ models แสดง "Shell env: off." เพราะอะไร?](#i-set-copilotgithubtoken-but-models-status-shows-shell-env-off-why)
- [เซสชันและหลายแชต](#sessions-and-multiple-chats)
  ...
  - [ทำไม context ถูกตัดกลางคันระหว่างงาน? ฉันจะป้องกันได้อย่างไร?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
...
### ฉันติดปัญหาอยู่ มีวิธีที่เร็วที่สุดในการแก้ให้หลุดจากปัญหานี้ไหม
