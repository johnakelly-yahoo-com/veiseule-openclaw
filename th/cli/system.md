...
read_when:
  ...
  - คุณต้องเปิดหรือปิดการทำงานของ heartbeat
...
ใส่เหตุการณ์ของระบบลงในคิวบนเซสชัน **main** 8. heartbeat ถัดไปจะฉีด
...
ทันที; `next-heartbeat`จะรอรอบถัดไปตามตาราง จัดคิวอีเวนต์ของระบบบนเซสชัน**หลัก** ฮาร์ตบีตถัดไปจะฉีดอีเวนต์
เป็นบรรทัด`System:`ในพรอมป์ต์ ใช้`--mode now`เพื่อทริกเกอร์ฮาร์ตบีต
