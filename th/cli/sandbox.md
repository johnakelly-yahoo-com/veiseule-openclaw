...
OpenClaw สามารถรันเอเจนต์ในคอนเทนเนอร์ Docker ที่แยกจากกันเพื่อความปลอดภัย OpenClaw สามารถรันเอเจนต์ในคอนเทนเนอร์ Docker ที่แยกออกจากกันเพื่อความปลอดภัย คำสั่ง `sandbox` ช่วยให้คุณจัดการคอนเทนเนอร์เหล่านี้ได้ โดยเฉพาะหลังการอัปเดตหรือเปลี่ยนแปลงการกำหนดค่า OpenClaw สามารถรันเอเจนต์ในคอนเทนเนอร์ Docker ที่แยกออกจากกันเพื่อความปลอดภัย คำสั่ง `sandbox` ช่วยให้คุณจัดการคอนเทนเนอร์เหล่านี้ได้ โดยเฉพาะหลังการอัปเดตหรือเปลี่ยนแปลงการกำหนดค่า
