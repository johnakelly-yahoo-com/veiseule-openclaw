...
ผ่าน WebSocket โดยจะคงการแมปเซสชันACPกับคีย์เซสชันของGateway คำสั่งนี้ใช้ACPผ่าน stdio สำหรับIDE และส่งต่อพรอมป์ไปยังGateway
...
แต่ละเซสชัน ACP จะถูกแมปกับคีย์เซสชันของ Gateway เพียงหนึ่งเดียว แต่ละเซสชัน ACP จะถูกแมปกับคีย์เซสชันของ Gateway เพียงหนึ่งเดียว แต่ละเซสชันACPจะถูกแมปกับคีย์เซสชันของGatewayเพียงหนึ่งค่า เอเจนต์หนึ่งตัวสามารถมีหลายเซสชันได้; ACPจะใช้ค่าเริ่มต้นเป็นเซสชัน `acp:<uuid>` แบบแยกอิสระ เว้นแต่คุณจะโอเวอร์ไรด์คีย์หรือเลเบล
