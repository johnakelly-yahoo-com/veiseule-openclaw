...
เอาต์พุตไว้ภายใน `--deliver` ยังคงอยู่ในฐานะชื่อแทนที่เลิกใช้แล้วของ `--announce` `--deliver` ยังคงอยู่ในฐานะชื่อแทนที่เลิกใช้แล้วของ `--announce`

หมายเหตุ: งานแบบครั้งเดียว (`--at`) จะถูกลบหลังจากสำเร็จตามค่าเริ่มต้น ใช้ `--keep-after-run` เพื่อเก็บไว้ ใช้ `--keep-after-run` เพื่อเก็บไว้ ใช้ `--keep-after-run` เพื่อเก็บไว้
