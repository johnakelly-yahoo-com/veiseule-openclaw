...
10. `voicecall` เป็นคำสั่งที่มาจากปลั๊กอิน `voicecall` เป็นคำสั่งที่มาจากปลั๊กอิน `voicecall` เป็นคำสั่งที่จัดเตรียมโดยปลั๊กอิน คำสั่งนี้จะแสดงเฉพาะเมื่อมีการติดตั้งและเปิดใช้งานปลั๊กอินการโทรด้วยเสียงแล้วเท่านั้น
