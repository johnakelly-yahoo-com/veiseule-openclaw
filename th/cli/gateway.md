...
- ตัวจัดการ `SIGINT`/`SIGTERM` จะหยุดโปรเซสgateway แต่จะไม่กู้คืนสถานะเทอร์มินัลที่กำหนดเอง หากคุณห่อหุ้มCLIด้วยTUIหรืออินพุตโหมดดิบ ให้คืนค่าเทอร์มินัลก่อนออก ตัวจัดการ `SIGINT`/`SIGTERM` จะหยุดโปรเซสgateway แต่จะไม่กู้คืนสถานะเทอร์มินัลที่กำหนดเอง หากคุณห่อหุ้มCLIด้วยTUIหรืออินพุตโหมดดิบ ให้คืนค่าเทอร์มินัลก่อนออก หากคุณห่อ CLI ด้วย TUI หรืออินพุตโหมดดิบ ให้กู้คืนสถานะเทอร์มินัลก่อนออก
...
`gateway probe` คือคำสั่ง“ดีบักทุกอย่าง” มันจะโพรบเสมอ: It always probes: It always probes:

- เกตเวย์ระยะไกลที่คุณตั้งค่าไว้(ถ้ามี) และ
- localhost(loopback) **แม้จะตั้งค่ารีโมตไว้แล้ว**

หากสามารถเข้าถึงเกตเวย์ได้หลายตัว จะพิมพ์แสดงทั้งหมด หากสามารถเข้าถึงเกตเวย์ได้หลายตัว จะพิมพ์แสดงทั้งหมด หากเข้าถึงเกตเวย์ได้หลายตัว มันจะแสดงทั้งหมด รองรับหลายเกตเวย์เมื่อคุณใช้โปรไฟล์/พอร์ตที่แยกกัน(เช่นบอตกู้ภัย) แต่การติดตั้งส่วนใหญ่ยังคงรันเกตเวย์เดียว
