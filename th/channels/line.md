...
บน Gateway และใช้ channel access token และ channel secret ของคุณเพื่อการยืนยันตัวตน LINE เชื่อมต่อกับ OpenClaw ผ่าน LINE Messaging API ปลั๊กอินทำงานเป็นตัวรับ webhook
บน Gateway และใช้ channel access token และ channel secret ของคุณเพื่อการยืนยันตัวตน

สถานะ: รองรับผ่านปลั๊กอิน สถานะ: รองรับผ่านปลั๊กอิน สถานะ: รองรับผ่านปลั๊กอิน รองรับข้อความส่วนตัว แชทกลุ่ม สื่อ ตำแหน่ง Flex
messages, template messages และ quick replies ไม่รองรับ reactions และ threads ไม่รองรับรีแอ็กชันและเธรด ไม่รองรับรีแอ็กชันและเธรด
...
ข้อความโดยตรงจะจับคู่เป็นค่าเริ่มต้น ข้อความโดยตรงจะจับคู่เป็นค่าเริ่มต้น ข้อความส่วนตัวจะตั้งค่าเป็นการจับคู่โดยค่าเริ่มต้น ผู้ส่งที่ไม่รู้จักจะได้รับโค้ดจับคู่
