...
Env vars ใช้ได้เฉพาะบัญชี **ค่าเริ่มต้น** (`default`) บัญชีอื่นต้องใช้ค่าจากคอนฟิก บัญชีอื่นต้องใช้ค่าคอนฟิก บัญชีอื่นต้องใช้ค่าคอนฟิก

## โหมดแชท

Mattermost ตอบ DM โดยอัตโนมัติ Mattermost ตอบกลับ DMs โดยอัตโนมัติ พฤติกรรมในช่องทางควบคุมด้วย `chatmode`: Mattermost ตอบกลับ DMs โดยอัตโนมัติ พฤติกรรมในช่องทางควบคุมด้วย `chatmode`:
