...
4. การเข้าถึง DM ค่าเริ่มต้นคือการจับคู่ (pairing) การเข้าถึงDMค่าเริ่มต้นคือการจับคู่ อนุมัติรหัสเมื่อบอตถูกติดต่อครั้งแรก การเข้าถึงDMค่าเริ่มต้นคือการจับคู่ อนุมัติรหัสเมื่อบอตถูกติดต่อครั้งแรก
...
- `channels.zalo.allowFrom`: allowlistสำหรับDM(รหัสผู้ใช้) `open` ต้องใช้ `"*"` ตัวช่วยจะถามรหัสตัวเลข `open` ต้องใช้ `"*"`. `open` ต้องใช้ `"*"`. วิซาร์ดจะขอ ID ที่เป็นตัวเลข
