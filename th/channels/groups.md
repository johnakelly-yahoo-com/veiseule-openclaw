...
OpenClaw “อาศัยอยู่” บนบัญชีการส่งข้อความของคุณเอง 44. 44. ไม่มีผู้ใช้บ็อต WhatsApp แยกต่างหาก
ไม่มีผู้ใช้บ็อต WhatsApp แยกต่างหาก
...
การตอบกลับข้อความจากบอทถือเป็นการกล่าวถึงโดยปริยาย (เมื่อช่องรองรับเมทาดาทาการตอบกลับ) การตอบกลับข้อความของบอตนับเป็นการกล่าวถึงโดยปริยาย(เมื่อช่องทางรองรับเมตาดาทาการตอบกลับ)ใช้กับTelegram, WhatsApp, Slack, Discord และMicrosoft Teams การตอบกลับข้อความของบอตนับเป็นการกล่าวถึงโดยปริยาย(เมื่อช่องทางรองรับเมตาดาทาการตอบกลับ)ใช้กับTelegram, WhatsApp, Slack, Discord และMicrosoft Teams
...
- `toolsBySender`: การแทนที่แบบต่อผู้ส่งภายในกลุ่ม(คีย์คือIDผู้ส่ง/ชื่อผู้ใช้/อีเมล/หมายเลขโทรศัพท์ตามช่องทาง)ใช้`"*"`เป็นไวลด์การ์ด ใช้ `"*"` เป็นไวลด์การ์ด ใช้ `"*"` เป็นไวลด์การ์ด
