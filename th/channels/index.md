...
OpenClaw สามารถคุยกับคุณบนแอปแชตใดก็ได้ที่คุณใช้อยู่แล้ว Each channel connects via the Gateway. Each channel connects via the Gateway.
...
- [IRC](/channels/irc) — เซิร์ฟเวอร์ IRC แบบดั้งเดิม; ช่องสนทนา + DM พร้อมการควบคุมแบบ pairing/allowlist.
...
- การตั้งค่าที่เร็วที่สุดมักจะเป็น **Telegram** (โทเคนบอทง่าย ๆ) การตั้งค่าที่เร็วที่สุดมักเป็น **Telegram** (โทเคนบอตแบบง่าย) ส่วน WhatsApp ต้องจับคู่ด้วย QR และ
  จัดเก็บสถานะบนดิสก์มากกว่า การตั้งค่าที่เร็วที่สุดมักเป็น **Telegram** (โทเคนบอตแบบง่าย) ส่วน WhatsApp ต้องจับคู่ด้วย QR และ
