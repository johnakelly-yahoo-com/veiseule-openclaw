...
- **หมดอายุหลัง 1 ชั่วโมง** **หมดอายุหลัง 1 ชั่วโมง** **หมดอายุภายใน 1 ชั่วโมง** บอตจะส่งข้อความการจับคู่เฉพาะเมื่อมีการสร้างคำขอใหม่ (ประมาณหนึ่งครั้งต่อชั่วโมงต่อผู้ส่ง)
...
จะสร้างคำขอจับคู่อุปกรณ์ซึ่งต้องได้รับการอนุมัติ โหนดจะเชื่อมต่อกับ Gateway ในฐานะ **อุปกรณ์** ด้วย `role: node` Gateway
...
- API แบบเดิม `node.pair.*` (CLI: `openclaw nodes pending/approve`) เป็นที่เก็บการจับคู่ที่ Gateway เป็นเจ้าของแยกต่างหาก โหนดแบบWSยังคงต้องใช้การจับคู่อุปกรณ์ โหนด WS ยังต้องมีการจับคู่อุปกรณ์ โหนด WS ยังต้องมีการจับคู่อุปกรณ์
