...
2. 41. พิมพ์ `@openclaw …` (หรือใส่หมายเลข) พิมพ์ `@openclaw …` (หรือใส่หมายเลข) พูด `@openclaw …` (หรือใส่หมายเลข) เฉพาะผู้ส่งที่อยู่ใน allowlist เท่านั้นที่จะกระตุ้นได้ เว้นแต่คุณตั้งค่า `groupPolicy: "open"`
