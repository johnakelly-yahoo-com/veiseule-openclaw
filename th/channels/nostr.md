...
Nostr เป็นโปรโตคอลแบบกระจายศูนย์สำหรับโซเชียลเน็ตเวิร์ก Nostr เป็นโปรโตคอลแบบกระจายศูนย์สำหรับโซเชียลเน็ตเวิร์ก Nostrเป็นโปรโตคอลแบบกระจายศูนย์สำหรับเครือข่ายสังคม ช่องทางนี้ช่วยให้OpenClawรับและตอบกลับข้อความส่วนตัว(DMs)ที่เข้ารหัสผ่านNIP-04ได้
...
ข้อมูลโปรไฟล์ถูกเผยแพร่เป็นอีเวนต์ NIP-01 `kind:0` ข้อมูลโปรไฟล์จะถูกเผยแพร่เป็นอีเวนต์`kind:0`ของNIP-01 คุณสามารถจัดการได้จากControl UI(Channels -> Nostr -> Profile)หรือกำหนดโดยตรงในคอนฟิก ข้อมูลโปรไฟล์จะถูกเผยแพร่เป็นอีเวนต์`kind:0`ของNIP-01 คุณสามารถจัดการได้จากControl UI(Channels -> Nostr -> Profile)หรือกำหนดโดยตรงในคอนฟิก
