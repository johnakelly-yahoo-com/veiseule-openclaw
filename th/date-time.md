...
เพื่อหลีกเลี่ยงการเรียกระบบซ้ำๆ เส้นทางรันไทม์เดียวกันนี้ทำงานได้กับ Bun `timeFormat` ควบคุมการแสดงผลแบบ **12 ชม./24 ชม.** ใน prompt โดย `auto` จะอิงตามการตั้งค่าของ OS ค่าที่ตรวจพบจะถูก **แคชต่อหนึ่งโปรเซส** เพื่อหลีกเลี่ยงการเรียกระบบซ้ำ
