...
ใช้รูปแบบแพตช์ที่มีโครงสร้างในการปรับใช้การเปลี่ยนแปลงไฟล์ ใช้รูปแบบแพตช์ที่มีโครงสร้างในการปรับใช้การเปลี่ยนแปลงไฟล์ ปรับใช้การเปลี่ยนแปลงไฟล์โดยใช้รูปแบบแพตช์ที่มีโครงสร้าง เหมาะอย่างยิ่งสำหรับการแก้ไขหลายไฟล์
...
- เส้นทางของแพตช์รองรับทั้งพาธแบบสัมพัทธ์ (จากไดเรกทอรีเวิร์กสเปซ) และพาธแบบสัมบูรณ์
...
- เป็นฟีเจอร์ทดลองและปิดไว้โดยค่าเริ่มต้น เป็นฟีเจอร์ทดลองและปิดไว้โดยค่าเริ่มต้น อยู่ในสถานะทดลองและปิดใช้งานเป็นค่าเริ่มต้น เปิดใช้งานด้วย `tools.exec.applyPatch.enabled`.
