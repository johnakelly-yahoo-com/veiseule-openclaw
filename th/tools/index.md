...
(การปฏิเสธมีผลเหนือกว่า) วิธีนี้ป้องกันไม่ให้ส่งเครื่องมือที่ไม่อนุญาตไปยังผู้ให้บริการโมเดล คุณสามารถอนุญาต/ปฏิเสธเครื่องมือแบบส่วนกลางได้ผ่าน `tools.allow` / `tools.deny` ใน `openclaw.json`
...
alongside tools (for example, the voice-call plugin). Some plugins ship their own skills
