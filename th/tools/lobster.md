...
ผู้ช่วยของคุณสามารถสร้างเครื่องมือที่จัดการตัวเองได้ ขอเวิร์กโฟลว์หนึ่งรายการ แล้ว 30 นาทีต่อมาคุณจะได้ CLI พร้อมไปป์ไลน์ที่ทำงานได้ด้วยการเรียกเพียงครั้งเดียว Lobster คือชิ้นส่วนที่ขาดหายไป: ไปป์ไลน์ที่กำหนดผลลัพธ์ได้แน่นอน (deterministic), การอนุมัติที่ชัดเจน, และสถานะที่ทำงานต่อได้ (resumable state)

## ทำไม

ปัจจุบัน เวิร์กโฟลว์ที่ซับซ้อนต้องอาศัยการเรียกใช้เครื่องมือโต้ตอบไปมาหลายครั้ง แต่ละครั้งมีต้นทุนเป็นโทเค็น และ LLM ต้องจัดลำดับทุกขั้นตอนเอง Lobster ย้ายการจัดลำดับนั้นไปสู่รันไทม์แบบกำหนดชนิดข้อมูล (typed runtime):
...
AI เป็นตัวเริ่มเวิร์กโฟลว์; Lobster ดำเนินการตามขั้นตอนต่าง ๆ ประตูการอนุมัติช่วยให้ผลข้างเคียงมีความชัดเจนและสามารถตรวจสอบย้อนหลังได้
