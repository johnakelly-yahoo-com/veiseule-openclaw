...
### ข้อกำหนดโหมด Foreground

เช่นเดียวกับ `canvas.*` โหนด iOS อนุญาตให้ใช้คำสั่ง `camera.*` ได้เฉพาะใน **โฟร์กราวด์** เท่านั้น การเรียกใช้งานในเบื้องหลังจะส่งคืน `NODE_BACKGROUND_UNAVAILABLE`. การเรียกใช้งานเบื้องหลังจะส่งคืน `NODE_BACKGROUND_UNAVAILABLE`
...
เช่นเดียวกับ `canvas.*` โหนด Android อนุญาตให้ใช้คำสั่ง `camera.*` ได้เฉพาะใน **โฟร์กราวด์** เท่านั้น การเรียกใช้งานในเบื้องหลังจะส่งคืน `NODE_BACKGROUND_UNAVAILABLE`. การเรียกใช้งานเบื้องหลังจะส่งคืน `NODE_BACKGROUND_UNAVAILABLE`
...
- **การตั้งค่า → ทั่วไป → อนุญาตให้ใช้กล้อง** (`openclaw.cameraEnabled`)
  - ค่าเริ่มต้น: **ปิด**
