...
- `/exec` แยกจาก elevated `/exec` แยกจาก elevated `/exec` แยกจาก elevated โดยจะปรับค่าเริ่มต้นการ exec ต่อเซสชันสำหรับผู้ส่งที่ได้รับอนุญาตเท่านั้น
...
ในโหมด `"non-main"` คีย์กลุ่ม/แชนเนลจะ _ไม่_ เป็น main ในโหมด `"non-main"` คีย์ของกลุ่ม/ช่องทางจะ _ไม่_ใช่ main ใช้คีย์เซสชัน main (แสดงโดย `sandbox explain`) หรือสลับโหมดเป็น `"off"` ในโหมด `"non-main"` คีย์ของกลุ่ม/ช่องทางจะ _ไม่_ใช่ main ใช้คีย์เซสชัน main (แสดงโดย `sandbox explain`) หรือสลับโหมดเป็น `"off"`
