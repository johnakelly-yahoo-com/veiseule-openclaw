...
การรันแบบภายในเครื่องทำได้ แต่ OpenClaw ต้องการบริบทขนาดใหญ่ + การป้องกันที่แข็งแกร่งต่อการโจมตีแบบ prompt injection การ์ดจอขนาดเล็กจะตัดทอนบริบทและทำให้การป้องกันด้านความปลอดภัยรั่วไหล ตั้งเป้าให้สูง: **≥2 Mac Studios ที่อัปเกรดเต็มสเปก หรือชุด GPU เทียบเท่า (~$30k+)** การ์ดจอ **24 GB** เพียงตัวเดียวใช้ได้เฉพาะกับพรอมป์ที่เบากว่าและมีความหน่วงสูงกว่า ใช้ **โมเดลเวอร์ชันที่ใหญ่ที่สุด / ขนาดเต็มที่คุณสามารถรันได้**; การควอนไทซ์อย่างหนักหรือเช็คพอยต์ “ขนาดเล็ก” จะเพิ่มความเสี่ยงต่อ prompt injection (ดู [Security](/gateway/security))
