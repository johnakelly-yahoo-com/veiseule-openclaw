...
vLLM, LiteLLM, OAI-proxy หรือเกตเวย์แบบกำหนดเองใช้ได้ หากเปิดเอ็นด์พอยต์สไตล์ OpenAI แบบ `/v1` แทนที่บล็อกผู้ให้บริการด้านบนด้วยเอ็นด์พอยต์และโมเดล ID ของคุณ: vLLM, LiteLLM, OAI-proxy หรือเกตเวย์แบบกำหนดเองใช้ได้ หากเปิดเอ็นด์พอยต์สไตล์ OpenAI แบบ `/v1` แทนที่บล็อกผู้ให้บริการด้านบนด้วยเอ็นด์พอยต์และโมเดล ID ของคุณ: Replace the provider block above with your endpoint and model ID:
