...
Tailscale จัดหา HTTPS การกำหนดเส้นทาง และ (สำหรับ Serve) เฮดเดอร์ระบุตัวตน สิ่งนี้ทำให้เกตเวย์ผูกกับ loopback ขณะที่
...
- `funnel`: HTTPS สาธารณะผ่าน `tailscale funnel` OpenClawต้องใช้รหัสผ่านที่ใช้ร่วมกัน `funnel`: HTTPS สาธารณะผ่าน `tailscale funnel` OpenClawต้องใช้รหัสผ่านที่ใช้ร่วมกัน OpenClaw ต้องใช้รหัสผ่านที่ใช้ร่วมกัน
...
- Serve/Funnel เปิดเผยเฉพาะ **Gateway control UI + WS** Serve/Funnel เปิดเผยเฉพาะ **Gateway control UI + WS** Serve/Funnel จะเปิดเผยเฉพาะ **Gateway control UI + WS** เท่านั้น โหนดจะเชื่อมต่อผ่าน
