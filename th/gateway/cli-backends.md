...
ถูกจำกัดอัตรา หรือทำงานผิดพลาดชั่วคราว แนวทางนี้ตั้งใจให้保守เป็นพิเศษ: This is intentionally conservative: This is intentionally conservative:
...
- **ไม่มีเครื่องมือของOpenClaw**(แบ็กเอนด์CLIจะไม่รับการเรียกเครื่องมือ)บางCLI
  อาจยังรันเครื่องมือเอเจนต์ของตนเอง **ไม่มีเครื่องมือของOpenClaw**(แบ็กเอนด์CLIจะไม่รับการเรียกเครื่องมือ)บางCLI
