...
เชื่อมต่อผ่านWebSocketและประกาศ **บทบาท** + **ขอบเขต** ของตนในช่วงแฮนด์เชค โปรโตคอลWSของGatewayเป็น **ระนาบควบคุมเดียว+ทรานสปอร์ตของโหนด** สำหรับ
OpenClaw ไคลเอนต์ทั้งหมด(CLI, เว็บUI, แอปmacOS, โหนดiOS/Android, โหนดแบบไม่มีส่วนหัว)
...
- หลังการจับคู่ Gatewayจะออก **โทเคนอุปกรณ์** ที่ผูกกับบทบาท+ขอบเขตของการเชื่อมต่อ
  โทเคนจะถูกส่งกลับใน `hello-ok.auth.deviceToken` และควรถูกบันทึกโดยไคลเอนต์เพื่อการเชื่อมต่อครั้งถัดไป หลังการจับคู่ Gatewayจะออก **โทเคนอุปกรณ์** ที่ผูกกับบทบาท+ขอบเขตของการเชื่อมต่อ
...
สคีมาTypeBoxใน `src/gateway/protocol/schema.ts` ขอบเขตที่แน่นอนถูกกำหนดโดยสคีมา TypeBox ใน `src/gateway/protocol/schema.ts` ขอบเขตที่แน่นอนถูกกำหนดโดยสคีมา TypeBox ใน `src/gateway/protocol/schema.ts`
