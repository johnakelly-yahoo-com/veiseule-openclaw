...
title: "แมนิเฟสต์ปลั๊กอิน"
---

# แมนิเฟสต์ปลั๊กอิน (openclaw.plugin.json)
...
11.
OpenClaw ใช้แมนิฟেস্টนี้เพื่อตรวจสอบการตั้งค่า **โดยไม่ต้องรันโค้ดปลั๊กอิน** 12. แมนิฟেস্টที่ขาดหายหรือไม่ถูกต้องจะถูกมองว่าเป็นข้อผิดพลาดของปลั๊กอินและบล็อก
