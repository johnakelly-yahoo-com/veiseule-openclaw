...
การทำอัตโนมัติและการแจ้งเตือน; สคริปต์เป็นตัวเสริมเพิ่มเติมสำหรับเวิร์กโฟลว์บนโทรศัพท์ OpenClaw เปิดเผยสถานะสุขภาพของวันหมดอายุ OAuth ผ่าน `openclaw models status` ใช้สิ่งนี้สำหรับ
