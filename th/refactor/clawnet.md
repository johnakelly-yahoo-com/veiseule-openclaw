...
- การ bind เริ่มต้น: loopback การ bind เริ่มต้น: loopback การผูกค่าเริ่มต้น: loopback การเข้าถึงระยะไกลผ่าน SSH/Tailscale
...
- ส่วนติดต่อผู้ใช้ควบคุมผ่านเว็บ → Gateway WS.
- ACP → Gateway WS.
...
บทบาทเป็นแบบต่อการเชื่อมต่อ ไม่ใช่ต่ออุปกรณ์ บทบาทเป็นแบบต่อการเชื่อมต่อ ไม่ใช่ต่ออุปกรณ์ บทบาทเป็นต่อการเชื่อมต่อ ไม่ใช่ต่ออุปกรณ์ อุปกรณ์หนึ่งอาจเปิดทั้งสองบทบาทได้ แยกกัน
...
การอนุมัติเกิดบนโฮสต์โหนด (รันไทม์โหนดของแอปmac) พรอมป์ต์ปรากฏที่ที่โหนดรัน พรอมป์ต์จะปรากฏในตำแหน่งที่โหนดทำงาน พรอมป์ต์จะปรากฏในตำแหน่งที่โหนดทำงาน
