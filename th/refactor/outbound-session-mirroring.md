...
- **การอนุมานเซสชันสำหรับการส่งผ่าน Gateway**: หากมีการระบุ `sessionKey` ให้ใช้ค่านั้น **การอนุมานเซสชันในการส่งผ่านGateway**: หากมี `sessionKey` ให้ใช้ค่านั้น หากไม่ระบุ ให้อนุมาน sessionKey จากเป้าหมาย + เอเจนต์เริ่มต้น และมิเรอร์ไปที่นั่น **การอนุมานเซสชันในการส่งผ่านGateway**: หากมี `sessionKey` ให้ใช้ค่านั้น หากไม่ระบุ ให้อนุมาน sessionKey จากเป้าหมาย + เอเจนต์เริ่มต้น และมิเรอร์ไปที่นั่น
...
- ปลั๊กอินโทรเสียงใช้คีย์เซสชันแบบกำหนดเอง `voice:<phone>` ปลั๊กอินการโทรด้วยเสียงใช้คีย์เซสชัน `voice:<phone>` แบบกำหนดเอง การแมปขาออกยังไม่เป็นมาตรฐานในส่วนนี้ หากเครื่องมือส่งข้อความควรรองรับการส่งแบบโทรด้วยเสียง ให้เพิ่มการแมปอย่างชัดเจน ปลั๊กอินการโทรด้วยเสียงใช้คีย์เซสชัน `voice:<phone>` แบบกำหนดเอง การแมปขาออกยังไม่เป็นมาตรฐานในส่วนนี้ หากเครื่องมือส่งข้อความควรรองรับการส่งแบบโทรด้วยเสียง ให้เพิ่มการแมปอย่างชัดเจน
