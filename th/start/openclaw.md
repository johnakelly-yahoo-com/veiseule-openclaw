...
- ขณะนี้ heartbeat ตั้งค่าเริ่มต้นเป็นทุก ๆ 30 นาที ฮาร์ตบีตตั้งค่าเริ่มต้นทุก 30 นาที ปิดไว้ก่อนจนกว่าจะเชื่อมั่นในการตั้งค่าโดยตั้งค่า `agents.defaults.heartbeat.every: "0m"` ฮาร์ตบีตตั้งค่าเริ่มต้นทุก 30 นาที ปิดไว้ก่อนจนกว่าจะเชื่อมั่นในการตั้งค่าโดยตั้งค่า `agents.defaults.heartbeat.every: "0m"`
...
หากคุณเชื่อม WhatsApp ส่วนตัวเข้ากับ OpenClaw ทุกข้อความที่ส่งถึงคุณจะกลายเป็น “อินพุตของเอเจนต์” ซึ่งแทบไม่ใช่สิ่งที่ต้องการ ซึ่งนั่นแทบจะไม่ใช่สิ่งที่คุณต้องการ ซึ่งนั่นแทบจะไม่ใช่สิ่งที่คุณต้องการ
...
ไฟล์แนบขาออกจากเอเจนต์: ใส่ `MEDIA:<path-or-url>` ไว้ในบรรทัดของมันเอง(ไม่มีเว้นวรรค) ตัวอย่าง: ตัวอย่าง: ตัวอย่าง:
